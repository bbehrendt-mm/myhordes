...
Encore
    ...
    .setOutputPath( local.output_service_path ??  'public/shared/')
    // public path used by the web server to access the output path
    .setPublicPath( local.public_service_path ?? '/shared/')
    // only needed for CDN's or sub-directory deploy
    .setManifestKeyPrefix('shared');
...
Encore
     ...
     */
    .addEntry('shared', './assets/ts/v2/shared.ts')
