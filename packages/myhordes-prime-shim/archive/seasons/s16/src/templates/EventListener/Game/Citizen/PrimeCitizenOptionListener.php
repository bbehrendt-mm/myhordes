...
#[AsEventListener(event: CitizenWorkshopOptionsEvent::class, method: 'onPopulateWorkshopRecipes',  priority: -1)]
final class PrimeCitizenOptionListener implements ServiceSubscriberInterface
{
