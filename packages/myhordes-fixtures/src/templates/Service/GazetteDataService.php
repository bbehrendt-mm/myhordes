...
class GazetteDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $data = array_replace_recursive($data, [
            ...
            ['text'=>'Heute morgen wurde eine Nachricht an <i class="dagger">†</i><strong> {cadaver1}s</strong> Haustür gefunden, auf der zu lesen war: "Ihr braucht zum Abendessen nicht auf mich zu warten. Ich schlafe heut draußen. Hab \'ne Stelle entdeckt, an der sehr gute Gegenstände vergraben sind. Wenn alles gut läuft, bin ich morgen in der Früh wieder zurück.',
           ...
           // GhulBeaten
            ...
            ['text'=>'Der Ghul <i class="dagger">†</i>{cadaver1} wurde gestern erschossen. Eine sorgfältig durchgeführte Untersuchung, die mit einer klassichen Hinrichtung endete – eine Meisterleistung.',
