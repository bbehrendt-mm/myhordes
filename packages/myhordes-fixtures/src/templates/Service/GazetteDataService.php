        ...
        $data = array_replace_recursive($data, [
            ...
            ['text'=>'Halten wir kurz inne und gedenken unserem verlorenen Schamanen. Auf Wiedersehen, nutzloser Scharlatan!',
                ...
                'variableTypes'=>[],
                        ...
                        ['text'=>'Der Wind flüsterte einen letzten Abschiedsgruß an †{cadaver1}, den Schamanen, dessen Verbindung zu den spirituellen Welten unterbrochen worden war.',
                'name'=>'gazetteTownDeadShaman_005',
                'type'=>GazetteEntryTemplate::TypeGazetteShamanDeath,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'variableTypes'=>[
                    ['type'=>"citizen",'name'=>'cadaver1'],
                        ...
                        ['text'=>'Es gibt eindeutige Hinweise darauf, dass unser Schamane die Grenzen des Wahnsinns überschritten hat. Und die des Lebens. Denn er ist gestorben.',
                'name'=>'gazetteTownDeadShaman_006',
                'type'=>GazetteEntryTemplate::TypeGazetteShamanDeath,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'variableTypes'=>[],
            ],
                        ['text'=>'Anscheinend hatte {citizen1} Recht, letztendlich waren alle Reden und Versprechen des Schamanen nur das: Reden und Versprechen.',
                'name'=>'gazetteTownDeadShaman_007',
                'type'=>GazetteEntryTemplate::TypeGazetteShamanDeathChaos,
                'requirement'=>GazetteEntryTemplate::RequiresOneCitizen,
                'variableTypes'=>[
                    ['type'=>"citizen", 'name'=>'citizen1'],
                        ...
                        ['text'=>'Es gibt eindeutige Hinweise darauf, dass unser Schamane die Grenzen des Wahnsinns überschritten hat. Und die des Lebens. Denn er ist gestorben.',
                'name'=>'gazetteTownDeadShaman_008',
                'type'=>GazetteEntryTemplate::TypeGazetteShamanDeathChaos,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'variableTypes'=>[],
            ],
            ...
            ['text'=>'Unser Führer in die andere Welt hat einen Weg gefunden! Den Weg zu seinem Grab.',
                'name'=>'gazetteTownDeadGuide_003',
                'type'=>GazetteEntryTemplate::TypeGazetteGuideDeath,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'variableTypes'=>[],
            ],
            ['text'=>'<i class="dagger">†</i>{cadaver1}, der viele Menschen durch die Wüste geführt hat, <strong>weilt nicht mehr unter uns</strong>. Die Außenwelt ist heute noch beängstigender geworden, denn ihr müsst euren Weg nun alleine finden.',
                'name'=>'gazetteTownDeadGuide_004',
                'type'=>GazetteEntryTemplate::TypeGazetteGuideDeathChaos,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'variableTypes'=>[
                    ['type'=>"citizen",'name'=>'cadaver1'],
            ...
            ['text'=>'Niemandem war es aufgefallen, wie schlecht es <strong><i class="dagger">†</i> {cadaver1}</strong> ging. Von Allen im Stich gelassen, hat er es vorgezogen, <strong>seinem Leben ein Ende zu setzten</strong>, anstatt weiter mit uns zu leben...',
            ...
            ['text'=>'Gestern ist einigen Bürgern aufgefallen, dass <strong><i class="dagger">†</i> {cadaver1}</strong> verdächtig still war. Anscheinend hat er es inzwischen vorgezogen, <strong>Selbstmord</strong> zu begehen.',
            ...
            ['text'=>'Gute Nachrichten! Wir können uns alle von <strong><i class="dagger">†</i> {cadaver1}</strong> verabschieden, der gestern beschlossen hat, sich von seinem Leben zu trennen.',
            ...
            ['text'=>'<strong>{citizen1}</strong> soll heute Morgen die Leiche von <strong><i class="dagger">†</i> {cadaver1}</strong> inmitten einer Baustelle gefunden haben. Laut diesem Bürger handelte es sich um einen Selbstmord.... Nur konnte <strong>{citizen1}</strong> uns das Messer, das im Rücken der Leiche steckte, nicht erklären...',
            ...
            ['text'=>'Und gerade sah es so aus, als würdet ihr euch gut schlagen... {cadavers} Bürger scheinen das Gegenteil zu glauben. <strong>Selbstmord</strong>, wie es aussieht. Und alle am selben Tag? Was für ein Zufall... Ich frage mich, ob sie es getan haben, um dem Leben zu entfliehen... oder  <strong>denen von euch, die noch übrig sind?</strong>',
                'name'=>'gazetteTownMultiSuicide_006',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiSuicide,
                'requirement'=>GazetteEntryTemplate::RequiresMultipleSuicides,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[
            ...
            ['text'=>'Es ist eine regelrechte Epidemie: {cadavers} Bürger haben gestern Zyanid zu sich genommen. Aber was hat sie dazu getrieben, so weit zu gehen?',
                'name'=>'gazetteTownMultiSuicide_007',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiSuicide,
                'requirement'=>GazetteEntryTemplate::RequiresMultipleSuicides,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[
            ...
            ['text'=>'Und während die Horden versuchten, unsere Mauern zu zerfressen, werden wir nicht vergessen, dass <strong><i class="dagger">†</i> {cadaver1}</strong> aufgrund von Medikamentenmangel im Sterben lag... <strong>Das war kein schöner Anblick, vor allem wegen des vielen Speichels, der ihm aus dem Mund lief...</strong>',
                'name'=>'gazetteTownAddiction_002',
                'type'=>GazetteEntryTemplate::TypeGazetteAddiction,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[
            ...
            ['text'=>'Großes Melodrama gestern während der Hängung von <strong><i class="dagger">†</i> {cadaver1}</strong>: <strong>{citizen1}</strong> soll aus Trauer versucht haben, die Feierlichkeiten zu verhindern, was er schlussendlich durch Gewalt sowie anderes <strong>anti-soziales Verhalten</strong> erreichen wollte. Einige Nachbarn sollen empfohlen haben, auch diesen Störenfried aufzuhängen...',
            ...
            ['text'=>'Die Gemeinde wollte dem Bürger <strong><i class="dagger">†</i> {cadaver1}</strong> den Schrecken des heutigen Angriffs ersparen, indem sie ihn tagsüber <strong>aufknüpften</strong>.',
            ...
            ['text'=>'Die Stadt hatte gestern beschlossen, <strong><i class="dagger">†</i> {cadaver1}</strong> zu erhängen. Leider verlief die Hinrichtung nicht reibungslos. Drei Anläufe waren nötig, um ihm schließlich das Genick zu brechen.',
            ...
            ['text'=>'Anstatt die Zombies gewähren zu lassen, beschlossen die Bürger gestern, <strong><i class="dagger">†</i> {cadaver1}</strong> im Voraus zu eliminieren. "Wir haben uns köstlich amüsiert", berichtet <strong>{citizen1}</strong>...',
            ...
            ['text'=>'Der Bürger <strong>{citizen1}</strong> war heute Morgen überglücklich über die summarische Hinrichtung von {cadavers} "Verrätern der Gemeinschaft". Ein "Beispiel für unsere schöne partizipative Demokratie in Aktion", soll dieser Bürger kommentiert haben.',
            ...
            ['text'=>'{cadavers} Seelen haben durch Erhängen ihr Ende gefunden, und wir beginnen uns zu fragen: <strong>Wie viele Ketten braucht eine Stadt?</strong>',
                'name'=>'gazetteTownMultiHanging_006',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiHanging,
                'requirement'=>GazetteEntryTemplate::RequiresMultipleHangings,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'Große Feier in der Stadt gestern, mit der <strong>Kreuzigung von </strong><strong><i class="dagger">†</i> {cadaver1}</strong>. Da ist mal was los und ein Schokoladenkreuz kann sich als köstlich UND nützlich erweisen.',
            ...
            ['text'=>'Wir hatten gestern alle viel Spaß in der Stadt, als wir <i class="dagger">†</i> {cadaver1} an ein Schokoladenkreuz genagelt haben. Wir mussten die Arbeit mit Klebeband beenden, weil wir alle Nägel aufgebraucht hatten, aber es war eine schöne Osterverpackung!',
                'name'=>'gazetteTownCross_002',
                'type'=>GazetteEntryTemplate::TypeGazetteChocolateCross,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'Wir hatten gestern alle viel Spaß in der Stadt, als wir {cadavers} Bürger an Schokoladenkreuze genagelt haben. Wir mussten sogar <i class="dagger">†</i> {cadaver1} mit Klebeband befestigen, weil wir keine Nägel mehr hatten. Das war eine schöne Osterveranstaltung!',
                'name'=>'gazetteTownMultiCross_002',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiChocolateCross,
                'requirement'=>GazetteEntryTemplate::RequiresMultipleCrosses,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'Die Meinungen über die Ursache für <i class="dagger">†</i><strong> {cadaver1}</strong> plötzlichen Tod gehen auseinander: Einige glauben, dass es sich um Selbstmord handelt, andere denken, dass <strong>{citizen1}</strong> der Mörder ist. Ich persönlich neige eher zur <strong>zweiten Hypothese</strong>...',
            ...
            ['text'=>'Neben den Zombieangriffen, müssen wir uns ab sofort auch auf Morde und Mordversuche in unseren eigenen Reihen einstellen. <i class="dagger">†</i><strong> {cadaver1}</strong> wurde bereits ermordert.',
            ...
            ['text'=>'Du solltest auch einen Blick auf die Leiche von <i class="dagger">†</i><strong> {cadaver1}</strong> werfen. Die Umstände des Todes könnten nicht fragwürdiger sein ... Hmm? Mord? Wer hat "Mord" gesagt?',
            ...
            ['text'=>'In der Stadt gibt es perfideere Menschen als mich. Ein Beweis dafür ist der gewaltsame Tod von <i class="dagger">†</i><strong> {cadaver1}</strong> gestern, der einem Mord zum Opfer fiel (Vergiftung mit {poison}, meiner Meinung nach). Es war sauber, ohne viel Dreck, obwohl es scheint dass <i class="dagger">†</i><strong> {cadaver1}</strong> sehr gelitten hat. Gute Arbeit, mach weiter so, Kollege.',
            ...
            ['text'=>'Vorsicht ist geboten! Ein Mörder versteckt sich unter uns! Gestern wurde die Leiche von <i class="dagger">†</i><strong> {cadaver1}</strong> gefunden, die Opfer einer Vergiftung wurde, vermutlich {poison} (fragt mich nicht, wie ich das herausgefunden habe). Wer ist der Mörder?',
            ...
            ['text'=>'Jemand konnte <i class="dagger">†</i><strong> {cadaver1}</strong> offensichtlich nicht leiden. Das <strong>Gift</strong>, welches gestern in sein Essen gemischt wurde, war äußerst effektiv.',
            ...
            ['text'=>'Wenn das Wasser komisch schmeckt, bist du vielleicht kurz davor, an einer Vergiftung zu vergehen. Wie <i class="dagger">†</i><strong> {cadaver1}</strong> gestern, dessen <strong>verdächtiger Tod</strong> viele Fragen aufwirft ...',
            ...
            ['text'=>'Die ganze Stadt freut sich über <i class="dagger">†</i><strong> {cadaver1}s</strong> Tod. Seine <strong>Infektion</strong> hat ihn endlich dahingerafft.',
            ...
            ['text'=> 'Ihr verwirrt mich alle. Warum baut ihr etwas so Wichtiges und ignoriert dann die roten Lichter und Warnsirenen, die <strong>ihr</strong> selbst eingebaut habt? Es ist fast so, als hättet ihr das <strong>gewollt</strong>. Es hat keinen Sinn, sich jetzt darüber zu beschweren, ihr seid alle menschlicher Schleim! Wenn es euch tröstet, die Zombies sind es auch.',
                'name'=>'gazetteTownReactor_002',
                'type'=>GazetteEntryTemplate::TypeGazetteReactor,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'variableTypes'=>[],
            ],
            ['text'=> 'In einem Blitz, der den Himmel erhellte, wurden alle Lebewesen in der Umgebung zu glücklichen Opfern des Atoms.',
                'name'=>'gazetteTownReactor_003',
                'type'=>GazetteEntryTemplate::TypeGazetteReactor,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'variableTypes'=>[],
                ],
            ...
            ['text'=>'Ihr müsst nicht mehr auf <i class="dagger">†</i><strong> {cadaver1}</strong> warten, er wird noch einige Zeit in der Wüste bleiben, nachdem er beschlossen hat, sich selbst zu erwürgen... auf nachdrückliches Anraten der gequälten Seele, die die Kontrolle über seinen Körper übernommen hat.',
            ...
            ['text'=>'Ich glaube, die Stadt muss mit dem Schamanen sprechen... <i class="dagger">†</i><strong> {cadaver1} </strong> wurde als leere Hülle gefunden (wenn man den Schaum vor dem Mund und den hasserfüllten Gesichtsausdruck ignoriert. <strong>Grauenhaft.</strong>). ',
                'name'=>'gazetteTownRedSoul_003',
                'type'=>GazetteEntryTemplate::TypeGazetteRedSoul,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'<i class="dagger">†</i> <strong>{cadaver1}</strong> ist bis jetzt noch nicht in die Stadt zurückgekehrt...',
            ...
            ['text'=>'Wieder ein Punkt für die Untoten. <i class="dagger">†</i> <strong>{cadaver1}</strong> gestern in der Außenwelt verschwunden.',
            ...
            ['text'=>'Keine Spur von <i class="dagger">†</i><strong> {cadaver1}</strong>. Es geht das Gerücht um, dass er gestern die Stadt verlassen hätte...',
            ...
            ['text'=>'Die Wüste wird zusehends gefährlicher! Jetzt ist auch <i class="dagger">†</i><strong> {cadaver1}</strong> verschwunden. Verlasst die Stadt bitte nicht mehr allein!',
            ...
            ['text'=>'<i class="dagger">†</i><strong> {cadaver1}</strong> wurde in der Außenwelt im Stich gelassen. Ihr habt ihn ermordet, ihr Egoisten! Ich hoffe, dass euch das Gleiche widerfährt!',
            ...
            ['text'=>'Hat irgendjemand Neuigkeiten von <i class="dagger">†</i><strong> {cadaver1}</strong>? Er gilt seit gestern als verschwunden.',
            ...
            ['text'=>'Wir haben noch immer keine Neuigkeiten von <i class="dagger">†</i><strong> {cadaver1}</strong>. Er wollte die Nacht draußen schlafen. Die nächsten Stunden werden uns sagen, ob das eine gute Idee war oder nicht.',
            ...
            ['text'=>'Heute morgen wurde eine Nachricht an <i class="dagger">†</i><strong> {cadaver1}s</strong> Haustür gefunden, auf der zu lesen war: "Ihr braucht zum Abendessen nicht auf mich zu warten. Ich schlafe heut draußen. Hab \'ne Stelle entdeckt, an der sehr gute Gegenstände vergraben sind. Wenn alles gut läuft, bin ich morgen in der Früh wieder zurück. <i class="dagger">†</i><strong> {cadaver1}</strong>"',
            ...
            // Eaten by Ghul
            ['text'=>'Wissenschaft: Welcher Teil des menschlichen Körpers ist am leckersten? Offensichtlich sind es das Herz und ein Teil des Verdauungssystems. Möglicherweise auch ein wenig die Milz. Das hat ein <strong>mysteriöser Kannibale</strong> gestern aus <i class="dagger">†</i> {cadaver1} herausgeschnitten. Seltsamerweise hat er sich nicht an den Füßen zu schaffen gemacht, die nach Meinung der übrigen Stadtbewohner doch auch einen ganz appetitlichen Duft verströmten.',
                'name'=>'gazetteTownGhulEaten_001',
            ...
            ['text'=>'<strong>{attack}</strong> Zombies wollten gestern Abend einen Snack. Einer von euch hatte jedoch auch Hunger ... zu viel Hunger. Die Knochen von <strong><i class="dagger">†</i> {cadaver1}</strong> wurden <strong>sauber abgeknabbert.</strong> Wir wissen, dass Zombies nicht so wählerisch sind. Von den Toten gefressen zu werden ist eine Sache ... aber <strong>von den Lebenden gefressen zu werden?</strong>',
                'name'=>'gazetteTownGhulEaten_002',
                'type'=>GazetteEntryTemplate::TypeGazetteGhulEaten,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'Es gibt perfidere Leute als mich in dieser Stadt. Der Beweis dafür ist der gewaltsame Tod von <strong>† {cadaver1}</strong> gestern, der von einem Verrückten zerfleischt wurde (der ihm die Leber, das Herz und {bodypart} entnommen hat). Es war sauber, ohne viel Dreck, auch wenn es den Anschein hat, dass <strong>† {cadaver1}</strong> enorm gelitten hat. Gute Arbeit, mach weiter so, lieber Freund.',
                'name'=>'gazetteTownGhulEaten_004',
                'type'=>GazetteEntryTemplate::TypeGazetteGhulEaten,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            // Multi Eaten by Ghul
            ['text'=>'Die Stadt ist zu einer Selbstbedienungs-<strong>Speisekammer</strong> geworden, seit {cadavers} Bürger gestern gefressen wurden. Und das macht viele Leute langsam nervös.',
                'name'=>'gazetteTownMultiGhulEaten_001',
            ...
            ['text'=>'Vorsicht! Unter uns verstecken sich Mörder! Gestern wurden mehrere Leichen von Bürgern gefunden, die auf grausame Weise verstümmelt wurden. Glaubt einem Experten: Die Mörder werden in den nächsten Tagen erneut zuschlagen...',
                'name'=>'gazetteTownMultiGhulEaten_003',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiGhulEaten,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[],
           ...
           // GhulStarved
            ['text'=>'Ein Ghul namens <i class="dagger">†</i>{cadaver1} wurde leblos in einer Gasse gefunden, sein Hunger hatte ihn schließlich überwältigt. Es wurden keine Bürger verletzt, aber es scheint, dass selbst Untote <strong>Hunger</strong> nicht überleben können.',
                'name'=>'gazetteTownGhulStarved_001',
            ...
            ['text'=>'Und wieder eine Monstrosität weniger! Der scheinbar ehrbare Bürger <i class="dagger">†</i>{cadaver1} war in Wirklichkeit ein blutrünstiger Mutant. Er erlag schließlich seiner Krankheit, <strong>von innen heraus zerfressen von seinem nach Menschenfleisch gierenden Organismus</strong>.',
                'name'=>'gazetteTownGhulStarved_002',
                'type'=>GazetteEntryTemplate::TypeGazetteGhulStarved,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            // Multi GhulStarved
            ['text'=>'Die Bürger waren schockiert, als sie vom Tod einer Bande von Ghulen in unserer Gemeinde erfuhren. Die Monster, die durch ihren unnatürlichen Hunger in Raserei geraten waren, haben sich schließlich gegenseitig verschlungen. Gut, dass wir sie los sind.',
                'name'=>'gazetteTownMultiGhulStarved_001',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiGhulStarved,
                'requirement'=>GazetteEntryTemplate::RequiresNothing,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[ ],
            ],            
           // GhulBeaten
            ...
            ['text'=>'Der Ghul <i class="dagger">†</i>{cadaver1} wurde gestern erschossen. Eine sorgfältig durchgeführte Untersuchung, die mit einer klassichen Hinrichtung endete – eine Meisterleistung.Der Ghul <i class="dagger">†</i>{cadaver1} wurde gestern erschossen. Eine sorgfältig durchgeführte Untersuchung, die mit einer klassichen Hinrichtung endete – eine Meisterleistung.',
                'name'=>'gazetteTownGhulBeaten_002',
                'type'=>GazetteEntryTemplate::TypeGazetteGhulBeaten,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            ['text'=>'Und wieder eine Monstrosität weniger! Der scheinbar ehrbare Bürger <i class="dagger">†</i>{cadaver1} war in Wirklichkeit ein blutrünstiger Mutant. Er wurde schließlich entlarvt und <strong>zu Tode geprügelt</strong>.',
                'name'=>'gazetteTownGhulBeaten_003',
                'type'=>GazetteEntryTemplate::TypeGazetteGhulBeaten,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
            ...
            // Multi GhulBeaten
            ['text'=>'Diese Stadt ist komplett von Ghulen überrannt! Wir haben gestern {cadavers} entsorgt, aber es gibt zweifellos noch mehr unter Ihren Nachbarn...',
                'name'=>'gazetteTownMultiGhulBeaten_001',
            ...
            ['text'=>'Gestern gab es in der Stadt einen schönen Fang, mit der <strong>Erlegung</strong> von {cadavers} Ghulen. Eine raffiniert durchgeführte Ermittlung, die in einem Blutbad endete – große Kunst.',
                'name'=>'gazetteTownMultiGhulBeaten_002',
                'type'=>GazetteEntryTemplate::TypeGazetteMultiGhulBeaten,
                'requirement'=>GazetteEntryTemplate::RequiresMultipleGhulBeaten,
                'fot' => GazetteEntryTemplate::FollowUpTypeBad,
                'variableTypes'=>[ 
           ...
           // FleshCage
            ['text'=>'Die Gemeinschaft verlangte, dass der Bürger <strong>† {cadaver1}</strong> einen Logenplatz für das Spektakel des Angriffs erhält, indem sie ihn <strong>in den Fleischkäfig warf</strong>. Wer ist jetzt an der Reihe?',
                'name'=>'gazetteTownFleshCage_001',
            ...
            // Multi FleshCage
            ['text'=>'<strong>Blut für den Blutgott!</strong> Gestern wurden {cadavers} Bürger für das Überleben der Stadt geopfert. Oder nur wegen des Spektakels? Auf jeden Fall wollen die Zombies mehr davon. Also, machen wir heute weiter?',
                'name'=>'gazetteTownMultiFleshCage_001',
           ...
           // Explosive doormate
            ...
            ['text'=>'Eine ganz normale Fußmatte... oder auch nicht. <i class="dagger">†</i>{cadaver1} musste auf die harte Tour lernen, dass die Willkommensmatte manchmal nicht nur eine Begrüßung ist, sondern manchmal auch <strong>eine Einbahnfahrkarte ins Jenseits</strong>.',
                'name'=>'gazetteTownExplosiveDoormat_003',
                'type'=>GazetteEntryTemplate::TypeGazetteExplosiveDoormat,
                'requirement'=>GazetteEntryTemplate::RequiresOneCadaver,
                'fot' => GazetteEntryTemplate::FollowUpTypeDoubt,
                'variableTypes'=>[
