...
class GazetteDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $data = array_replace_recursive($data, [
            ...
            ['text'=>'Und während die Horden versuchten, unsere Mauern zu zerfressen, werden wir nicht vergessen, dass <strong>† {cadaver1}</strong> aufgrund von Medikamentenmangel im Sterben lag... <strong>Das war kein schöner Anblick, vor allem wegen des vielen Speichels, der ihm aus dem Mund lief...</strong>',
