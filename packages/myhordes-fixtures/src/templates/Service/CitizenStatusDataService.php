...
class CitizenStatusDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $data = array_replace_recursive($data, [
            ...
            'good_smell'=> ['name' => 'good_smell', 'label' => 'Good smell', 'description' => 'Du riechst... komisch. Aber auf eine gute Art.', 'volatile' => true],
            ...
            'tg_meta_wound' => ['name' => 'tg_meta_wound', 'volatile' => false],
            'tg_clothes' => ['name' => 'tg_clothes', 'volatile' => true],
            'tg_teddy' => ['name' => 'tg_teddy', 'volatile' => true],
            'tg_guitar' => ['name' => 'tg_guitar', 'volatile' => true],
            'tg_sbook' => ['name' => 'tg_sbook', 'volatile' => true],
            'tg_steal' => ['name' => 'tg_steal', 'volatile' => true],
            'tg_home_upgrade' => ['name' => 'tg_home_upgrade', 'volatile' => true],
            ...
            'tg_chk_movewb' => ['name' => 'tg_chk_movewb', 'volatile' => true],
            'tg_hide' => ['name' => 'tg_hide', 'volatile' => true],
            'tg_tomb' => ['name' => 'tg_tomb', 'volatile' => true],
            'tg_home_clean' => ['name' => 'tg_home_clean', 'volatile' => true],
            'tg_home_shower' => ['name' => 'tg_home_shower', 'volatile' => true],
            'tg_home_heal_1' => ['name' => 'tg_home_heal_1', 'volatile' => true],
            'tg_home_heal_2' => ['name' => 'tg_home_heal_2', 'volatile' => true],
            'tg_home_defbuff' => ['name' => 'tg_home_defbuff', 'volatile' => true],
            'tg_rested' => ['name' => 'tg_rested', 'volatile' => true ],
            'tg_shaman_immune' => ['name' => 'tg_shaman_immune', 'volatile' => false ],
            'tg_shaman_heal' => ['name' => 'tg_shaman_heal', 'volatile' => true ],
            'tg_ghoul_eat' => ['name' => 'tg_ghoul_eat', 'volatile' => true ],
            'tg_no_hangover' => ['name' => 'tg_no_hangover', 'volatile' => true ],
            'tg_ghoul_corpse' => ['name' => 'tg_ghoul_corpse', 'volatile' => true ],
            'tg_betadrug' => ['name' => 'tg_betadrug', 'volatile' => true ],
            'tg_build_vote' => ['name' => 'tg_build_vote', 'volatile' => true ],
            'tg_meta_winfect' => ['name' => 'tg_meta_winfect', 'volatile' => false ],
            'tg_infect_wtns' => ['name' => 'tg_infect_wtns', 'volatile' => false ],
            'tg_insurrection' => ['name' => 'tg_insurrection', 'volatile' => true],
            'tg_got_xmas_gift' => ['name' => 'tg_got_xmas_gift', 'volatile' => false],
            'tg_april_ooze' => ['name' => 'tg_april_ooze', 'volatile' => true],
            'tg_paranoid' => ['name' => 'tg_paranoid', 'volatile' => false],
            'tg_novlamps' => ['name' => 'tg_novlamps', 'volatile' => true],
            'tg_air_ghoul' => ['name' => 'tg_air_ghoul', 'volatile' => false],
            'tg_air_infected' => ['name' => 'tg_air_infected', 'volatile' => false],
            'tg_tried_pp' => ['name' => 'tg_tried_pp', 'volatile' => true],
            'tg_meta_ginfect' => ['name' => 'tg_meta_ginfect', 'volatile' => false],
            ...
            'tg_msk_scared' => ['name' => 'tg_msk_scared', 'volatile' => false ],
        ]);
    }
}
