...
class RecipeDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $data = array_replace_recursive($data, [
            ...
            'ws027' => ['type' => Recipe::WorkshopTypeTechSpecific, 'provoking' => 'meca_parts_#00',    'in' => ['meca_parts_#00', 'plate_#00', 'plate_#00' ],                                      'out' => 'car_door_#00', 'action' => 'Wandeln' ], //Car door, TODO : fix workshop logs since it don't says the number : display only 1 despite consuming 2 plate
            ...
            'ws029' => ['type' => Recipe::WorkshopTypeTechSpecific, 'provoking' => 'bone_meat_#00',     'in' => ['bone_meat_#00', 'poison_part_#00' ],                                              'out' => ['bone_#00', 'smelly_meat_#00'], 'multi_out' => true, 'action' => 'Wandeln' ], //Broken human bone + Festering Flesh, TODO : fix randomness, it should gives both items and not one or the other
            'ws030' => ['type' => Recipe::WorkshopTypeTechSpecific, 'provoking' => 'knife_#00',         'in' => ['wood_log_#00', 'knife_#00', 'rustine_#00' ],                                      'out' => 'saw_tool_part_#00', 'action' => 'Wandeln' ], //Makeshift Hacksaw, TODO : Fix workshop log + implement Makeshift Hacksaw item & functionning
