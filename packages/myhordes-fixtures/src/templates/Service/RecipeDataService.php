...
class RecipeDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $data = array_replace_recursive($data, [
            ...
            'ws029' => ['type' => Recipe::WorkshopTypeTechSpecific, 'provoking' => 'bone_meat_#00', 'in' => ['bone_meat_#00', 'poison_part_#00' ],      'out' => ['bone_#00', 'smelly_meat_#00'], 'action' => 'Wandeln' ], //Broken human bone + Festering Flesh, TODO : fix randomness, it should gives both items and not one or the other
