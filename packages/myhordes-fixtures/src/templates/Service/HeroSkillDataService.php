...
class HeroSkillDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data): void
    {
        $data = array_replace_recursive($data, [
            ...
            'luckyfind' => ['name' => 'luckyfind', 'title' => 'Schönes Fundstück', 'description' => 'Mit deiner Heldenfähigkeit "Fundstück" stöberst du jetzt NOCH BESSERE Gegenstände auf.', 'icon' => 'item_chest_hero', 'daysNeeded' => 121, 'action' => 'hero_generic_find'],
