...
class BuildingDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $container->add()->parentBuilding($small_wallimprove)
            ...
            ->isTemporary(0)->defense(0)->ap(20)->blueprintLevel(0)->resources(["wood2_#00" => 6,"metal_#00" => 2,"meca_parts_#00" => 1,])->orderBy(17)->commit($small_round_path);
        ...
        $container->add()->parentBuilding($item_vegetable_tasty)
            ...
            ->isTemporary(0)->defense(0)->ap(30)->health(30)->blueprintLevel(2)->resources(["water_#00" => 10,"wood2_#00" => 5,"explo_#00" => 5,])->orderBy(0)->commit($item_bgrenade);
        $container->add()->parentBuilding($item_vegetable_tasty)
        ...
        $container->add()->parentBuilding($item_rp_book2)
            ...
            ->isTemporary(0)->defense(0)->ap(50)->health(50)->blueprintLevel(0)->resources(["drug_#00" => 1,"vodka_#00" => 1,"wood_beam_#00" => 5,"ryebag_#00" => 2,])->orderBy(4)->commit();
        ...
        $container->add()->parentBuilding($small_watchmen)
            ...
            ->isTemporary(0)->defense(0)->ap(50)->health(50)->blueprintLevel(2)->resources(["meca_parts_#00" => 3,"wood2_#00" => 15,"metal_#00" => 10,"plate_#00" => 4,"concrete_wall_#00" => 2,"wood_beam_#00" => 5,])->orderBy(3)->commit($small_armor);
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->isTemporary(0)->defense(0)->ap(50)->health(0)->blueprintLevel(3)->resources(["concrete_wall_#00" => 2,"wood_beam_#00" => 15,"metal_beam_#00" => 10,])->orderBy(8)->commit($small_city_up);
        $container->add()->parentBuilding($small_building)
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->isImpervious(true)->isTemporary(0)->defense(0)->ap(300)->health(0)->blueprintLevel(4)->resources(["meca_parts_#00" => 2,"metal_#00" => 30,])->orderBy(20)->commit();
        $container->add()->parentBuilding($small_building)
            ...
            ->isImpervious(true)->isTemporary(0)->defense(0)->ap(300)->health(0)->blueprintLevel(4)->resources(["water_#00" => 20,"meca_parts_#00" => 5,"concrete_wall_#00" => 3,"metal_beam_#00" => 5,])->orderBy(22)->commit();
        $container->add()->parentBuilding($small_building)
            ...
            ->isImpervious(true)->isTemporary(0)->defense(0)->ap(300)->health(0)->blueprintLevel(4)->resources(["water_#00" => 30,"wood_beam_#00" => 15,"metal_beam_#00" => 10,])->orderBy(23)->commit();
        $container->add()->parentBuilding($small_building)
