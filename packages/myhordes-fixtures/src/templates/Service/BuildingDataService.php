...
class BuildingDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $container->add()->parentBuilding($small_gather)
            ...
            ->adjustForHardMode(null, ["water_#00" => 60,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_barbed)
            ...
            ->adjustForHardMode(null, ["bone_meat_#00" => 4,])->autoEasyMode()
            ->blueprintLevel(0)->orderBy(0)->commit();
        ...
        $container->add()->parentBuilding($small_wallimprove)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 40,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_wallimprove)
            ...
            ->adjustForHardMode(null, ["metal_#00" => 40,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_wallimprove)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 60,"metal_#00" => 60,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($item_jerrycan)
            ...
            ->adjustForHardMode(null, ["water_#00" => 30,"metal_#00" => 12,"explo_#00" => 3,"deto_#00" => 3,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($item_vegetable_tasty)
            ...
            ->adjustForHardMode(null, ["water_#00" => 30,"wood2_#00" => 20,"explo_#00" => 15,'oilcan_#00' => 4])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_waterspray)
            ...
            ->adjustForHardMode(null, ["water_#00" => 60,"tube_#00" => 4,"wood_beam_#00" => 21,"metal_beam_#00" => 45,'diode_#00' => 3])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_waterspray)
            ...
            ->adjustForHardMode(null, ["water_#00" => 45,"wood2_#00" => 20,"metal_#00" => 20,"metal_beam_#00" => 15,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($item_tagger)
            ...
            ->adjustForHardMode(null, ["rustine_#00" => 4,"electro_#00" => 3,])->autoEasyMode()
            ->blueprintLevel(1)->orderBy(1)->commit();
        ...
        $container->add()->parentBuilding($small_wallimprove)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 20,"metal_#00" => 20,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($status_terror)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 24,])->autoEasyMode()
            ->blueprintLevel(0)->orderBy(0)->commit();
        $container->add()->parentBuilding($status_terror)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 20,])->autoEasyMode()
            ->blueprintLevel(0)->orderBy(1)->commit();
        $container->add()->parentBuilding($status_terror)
            ...
            ->adjustForHardMode(null, ["wood_beam_#00" => 9,"metal_beam_#00" => 9,"metal_#00" => 20,"rustine_#00" => 4,"wire_#00" => 3,])->autoEasyMode()
            ->blueprintLevel(0)->orderBy(1)->commit();
        $container->add()->parentBuilding($status_terror)
        ...
        $container->add()->parentBuilding($item_tagger)
            ...
            ->adjustForHardMode(
                null, ["meca_parts_#00" => 3,"deto_#00" => 3,"lens_#00" => 6,"diode_#00" => 6,"metal_beam_#00" => 24,"wire_#00" => 3, "pile_#00" => 16],
                null, ["meca_parts_#00" => 1,"deto_#00" => 1,"lens_#00" => 1,"diode_#00" => 1,"metal_beam_#00" => 6,"wire_#00" => 1, "pile_#00" => 3],
            )
        ...
        $container->add()->parentBuilding($small_eden)
            ...
            ->adjustForHardMode(null, ["wood2_#00" => 20,"wood_beam_#00" => 30,"metal_beam_#00" => 45,"tube_#00" => 4,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->adjustForHardMode(
                null, ["concrete_wall_#00" => 6,"wood_beam_#00" => 45,"metal_beam_#00" => 30,'metal_#00' => 20],
                null, ["concrete_wall_#00" => 1,"wood_beam_#00" => 11,"metal_beam_#00" => 8,'metal_#00' => 3],
            )
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->adjustForHardMode(null, ["meca_parts_#00" => 3,"wood2_#00" => 40,"metal_#00" => 60,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->isTemporary(0)->defense(100)
            ->ap(90)->health(90)->resources(["firework_powder_#00" => 1,"firework_tube_#00" => 1,"firework_box_#00" => 2])
            ->adjustForHardMode(
                null, ["firework_powder_#00" => 1,"firework_tube_#00" => 1,"firework_box_#00" => 2, 'metal_beam_#00' => 10, 'wood_beam_#00' => 10, 'rustine_#00' => 5, 'torch_#00' => 3],
                null, ["firework_powder_#00" => 1,"firework_tube_#00" => 1,"firework_box_#00" => 2],
            )
            ->blueprintLevel(0)
            ->orderBy(10)->commit();
        $container->add()->parentBuilding($item_rp_book2)
        ...
        $container->add()->parentBuilding($small_building)
            ...
            ->adjustForHardMode(null, ["water_#00" => 150,"wood_beam_#00" => 60,"metal_beam_#00" => 40,])->autoEasyMode()
        ...
        $container->add()->parentBuilding($small_gather)
            ...
            ->adjustForHardMode(null, ["explo_#00" => 3, "wood_beam_#00" => 9, "deto_#00" => 3,])->autoEasyMode()
