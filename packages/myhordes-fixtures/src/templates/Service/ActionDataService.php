...
class ActionDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data): void
    {
        ...
        $requirement_container->add()->identifier('must_not_have_lab')->type( Requirement::HideOnFail )->add( (new BuildingRequirement())->building('item_acid_#00', false) )->commit();
        ...
        $requirement_container->add()->identifier('must_be_outside_within_11km')->type( Requirement::MessageOnFail )->add( (new LocationRequirement())->beyond(true)->exploring(null)->maxKm(11) )->text('Du bist <strong>zu weit von der Stadt entfernt</strong>, um diese Fähigkeit benutzen zu können! Genauer gesagt bist du {km_from_town} km entfernt. Die maximale Entfernung darf höchstens 11 km betragen.')->commit();
