    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'eat_7ap_hw_2' => [ 'label' => 'Essen', 'priority' => 1, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'eat_ap', 'no_full_ap_msg_food', 'h_during_halloween' ], 'result' => [ 'contaminated_zone_infect', 'eat_ap7', 'consume_item', ['group' => [
                    [ ['do_nothing'], 25 ],
                    [ ['unterrorize'], 75 ],
                ...
                'open_foodbox'   => [ 'label' => 'Öffnen', 'at00' => true, 'meta' => [ 'not_profession_tech', 'have_parcel_opener', 'is_not_wounded_hands' ], 'result' => [ 'consume_item', 'spawn_foodbox' ], 'message_key' => 'container_open_weapon' ],
                ...
                'open_foodbox_t1'    => [ 'label' => 'Öffnen', 'at00' => true, 'meta' => [ 'profession_tech', 'have_parcel_opener_hd', 'is_not_wounded_hands' ], 'result' => [ 'consume_item', 'spawn_foodbox' ], 'message_key' => 'container_open_weapon' ],
                ...
                'open_foodbox_t2'    => [ 'label' => 'Öffnen (1 BP)', 'at00' => true, 'meta' => [ 'profession_tech', 'not_have_parcel_opener_hd', 'min_1_cp' ], 'result' => [ 'minus_1cp', 'consume_item', 'spawn_foodbox' ], 'message_key' => 'container_open' ],
                ...
                'watercup_1' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_inside', 'must_have_micropur_in', 'must_not_have_purifier', 'must_not_have_filter', 'must_not_be_banished' ], 'result' => [ 'consume_micropur', 'consume_item', 'picto_ban_emanc', 'spawn_1_watercup' ], 'message_key' => 'item_clean_watercup' ],
                'watercup_2' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_outside_or_exploring', 'must_have_micropur', 'must_not_be_banished' ], 'result' => [ 'consume_micropur', 'consume_item', 'picto_ban_emanc', 'spawn_1_watercup' ], 'message_key' => 'item_clean_watercup' ],
                ...
                'jerrycan_1' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_inside', 'must_have_micropur_in', 'must_not_have_purifier', 'must_not_be_banished' ], 'result' => [ 'consume_micropur', 'consume_item', ['group' => [
                    [ 'spawn_2_water', 75 ],
                    [ 'spawn_3_water', 25 ] //jerrycan + tablet inside town
                ]] ], 'message_key' => 'item_clean' ],
                'jerrycan_2' => [ 'label' => 'In den Brunnen schütten', 'meta' => [ 'must_be_inside', 'must_have_purifier', 'must_not_have_filter', 'must_not_be_banished' ], 'result' => [ 'consume_item', ['group' => [
                    [ 'town_well_2', 40 ],
                    [ 'town_well_3', 35 ],
                    [ 'town_well_4', 25 ] //jerrycan with purifier
                ]] ], 'message_key' => 'water_to_well' ],
                'jerrycan_3' => [ 'label' => 'In den Brunnen schütten', 'meta' => [ 'must_be_inside', 'must_have_filter', 'must_not_be_banished' ], 'result' => [ 'consume_item', ['group' => [
                    [ 'town_well_3', 5 ],
                    [ 'town_well_4', 15 ],
                    [ 'town_well_5', 20 ],
                    [ 'town_well_6', 20 ],
                ...
                'jerrycan_4' => [ 'label' => 'Reinigen (1AP) (Wasser)', 'meta' => [ 'min_1_ap', 'must_be_outside', 'must_have_micropur_in' ], 'result' => [ 'consume_micropur', 'consume_item', 'spawn_1_water_inv', 'minus_1ap' ], 'message_key' => 'item_clean' ], //jerrycan + tablet outside town
                ...
                'hero_guard'      => [ 'label' => 'Senken', 'at00' => true, 'cover' => true, 'meta' => [], 'result' => [ 'hero_guard_gone' ],  'message' => 'Du senkst deinen Schild. Zwar kannst du dich jetzt nicht mehr so gut verteidigen, dafür kannst du aber einen weiteren, schweren Gegenstand mit dir führen.' ],
                ...
                'hero_scavenger' => [ 'label' => 'Zone ausheben', 'tooltip' => 'Es sieht so aus, als könntest du mit deiner Schaufel an dieser Stelle tiefer graben als sonst... Möglicherweise kannst du dieser Zone neues Leben einhauchen, sodass du und andere Bürger hier wieder wertvolle Gegenstände finden können? Du kannst diese Aktion nur einmal pro Tag verwenden. Außerdem kann jede Zone nur einmalig durch diese Aktion erneuert werden.', 'meta' => [ 'must_be_outside', 'profession_collec', 'scav_counter_below_1', 'zone_not_force_regenerated', 'zone_must_be_empty' ], 'result' => [ 'hero_scavenger', 'increase_scavenger_counter', 'stop_digging' ], 'message' => 'Du hast diese Zone erfolgreich ausgehoben und zahlreiche neue Buddelmöglichkeiten entdeckt.' ],
                ...
                'hero_generic_ap'           => [ 'label' => 'Zweite Lunge', 'tooltip' => '<nc-HeroSecondWindBonusAP op="gt" val="0">Verschafft dir {' . CitizenProperties::HeroSecondWindBaseSP->translationKey() . '} frische Erkundungspunkte.</nc-HeroSecondWindBonusAP><c-HeroSecondWindBonusAP op="gt" val="0">Verschafft dir {' . CitizenProperties::HeroSecondWindBaseSP->translationKey() . '} frische Erkundungspunkte, stellt {' . CitizenProperties::HeroSecondWindBonusAP->translationKey() . '} AP wieder her und beseitigt deine Müdigkeit.</c-HeroSecondWindBonusAP>', 'cover' => true, 'at00' => true, 'meta' => [ 'not_yet_hero'], 'result' => [ 'hero_act', 'just_ap_sw'], 'message' => 'Du atmest tief durch und drückst den Rücken durch. Auf geht\'s! Ich werde nicht hier sterben!{hr}Du hast soeben Kraft getankt und <strong>{sp} neue EP<c-HeroSecondWindBonusAP op="gt" val="0"> sowie {ap} neue AP</c-HeroSecondWindBonusAP> erhalten</strong>.'],
                ...
                'hero_generic_fs_xp'        => [ 'label' => 'Erfahrung teilen', 'tooltip' => 'Du gibst 5 Erfahrungspunkte aus, damit ein anderer Spieler 10 Erfahrungspunkte erhält.', 'confirm' => true, 'confirmMsg' => 'Möchtest du 5 Erfahrungspunkte ausgeben, damit {target} 10 Erfahrungspunkte erhält? Hinweis: Pro Saison kannst du dem gleichen Spieler maximal 3x Erfahrung spenden.' ,'target' => ['type' => ItemTargetDefinition::ItemFriendshipXPType], 'meta' => [ 'not_yet_hero', 'can_use_friendship'], 'result' => [ 'hero_act', 'hero_sxp' ], 'message' => 'Du hast deine Erfahrung an {citizen} weitergegeben.' ],
                ...
                'hero_armag'           => [ 'label' => 'Durchgang in Kraft', 'tooltip_key' => 'heroic_arma_tooltip_h', 'allow_when_terrorized' => true, 'meta' => [ 'not_yet_hero','must_be_outside', 'must_be_blocked' ], 'result' => [ 'hero_act', 'msg_heroic_arma_success', 'zone_escape_300_armag', 'kill_1_zombie_s']],
                ...
                'home_crows'     => [ 'label' => 'Die Wüste kartographieren', 'meta' => [ 'must_be_inside', 'min_1_ap', 'profession_hunter', 'must_have_crowsnest', 'hunter_building_counter_below_1' ], 'result' => [ 'minus_1ap', 'status_count_hunter', 'status_start_sp' ], 'message' => 'Nichts entgeht deinem geschulten Blick! All die gesammelten Informationen werden dir morgen helfen, die geschickt und mit maximaler Effizienz durch die Außenwelt zu bewegen.' ],
                ...
                'home_pool'    => [ 'label' => 'Ein Bad nehmen', 'meta' => [ 'must_be_inside', 'must_have_pool', 'pool_has_water', 'not_yet_home_pooled' ], 'result' => [ 'status_home_pool', 'status_good_smell' ], 'message' => 'Du springst ohne zu zögern in dieses große Bad. Das Chaos um dich herum existiert für dich nicht mehr und du spürst, dass du diese Nacht mit Gelassenheit verbringen wirst.' ],
                ...
                'equip_bike_first' => [ 'label' => 'Aufsteigen', 'at00' => true, 'meta' => ['is_not_wounded_hands','not_yet_bike_today','not_yet_bike_now','is_not_wounded_foot','is_not_wounded_leg','room_for_heavy_item'], 'result' => [ 'equip_item', 'status_tag_bike_now', 'status_tag_bike_today', 'status_tag_bike_first', 'plus_2sp_e' ], 'message' => 'Du steigst auf dein Fahrrad und bereitest dich mental darauf vor, in Windeseile durch die Außenwelt zu fegen.' ],
                'unequip_bike_first' => [ 'label' => 'Absteigen', 'at00' => true, 'meta' => ['bike_now'], 'result' => [ 'unequip_item', 'status_tag_no_bike_now', 'status_tag_no_bike_first', 'status_tag_bike_today', 'minus_2sp' ], 'message' => 'Mit ein wenig Trennungsschmerz im Herzen steigst du von deinem Fahrrad ab.' ],
            ...
            'heroics' => [
                ...
                'hero_generic_find_lucky2' => ['name' => 'hero_generic_find_lucky2', 'unlockable' => true, 'used' => 'Du hast heute schon verdammt viel Schwein gehabt. So viel Glück kannst du erst in deinem nächsten Leben wieder haben...', 'replace' => 'hero_generic_find_lucky'],
                'hero_generic_find_lucky3' => ['name' => 'hero_generic_find_lucky3', 'unlockable' => true, 'used' => 'Du hast heute schon verdammt viel Schwein gehabt. So viel Glück kannst du erst in deinem nächsten Leben wieder haben...', 'replace' => 'hero_generic_find_lucky2'],
            ...
            'items' => [
                ...
                'moldy_food_subpart_#00' => [ 'eat_4ap'],
            ...
            'message_keys' => [
                ...
                'heroic_arma_tooltip_h'     => 'Du tötest 1 Zombie in der Zone und erhältst du die Kontrolle über die Zone für 5 Minuten.',
                ...
                'msg_soccer_success'      		=> 'Du jonglierst mit dem Ball und schaffst es sehr gut, den Ball in der Luft zu halten. Man könnte dich fast für einen professionellen Fußballspieler halten!<hr />Du hattest viel Spaß und erhältst <strong>1 Erkundungspunkt</strong>.',
