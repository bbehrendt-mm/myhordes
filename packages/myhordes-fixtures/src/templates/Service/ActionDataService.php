    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'hero_armag'           => [ 'label' => 'Durchgang in Kraft', 'tooltip_key' => 'heroic_arma_tooltip_h', 'allow_when_terrorized' => true, 'meta' => [ 'not_yet_hero','must_be_outside', 'must_be_blocked' ], 'result' => [ 'msg_heroic_arma_success', 'zone_escape_300_armag', 'kill_1_zombie_s']],
