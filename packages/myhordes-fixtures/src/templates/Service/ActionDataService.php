    ...
    public function process(array &$data): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'hero_generic_punch'        => [ 'label' => 'Wildstyle Uppercut', 'tooltip' => 'Damit kannst du mit einem Schlag {cfg.ctp.' . CitizenProperties::HeroPunchKills->value . '} Zombies umbringen!', 'meta' => [ 'must_be_outside_or_exploring', 'must_have_zombies', 'not_yet_hero'], 'result' => [ 'hero_act', 'zone_kill_punch'], 'message' => 'Mit Hilfe deiner übermenschlichen Heldenkräfte hast du <strong>{kills} Zombie(s)</strong> platt gemacht!' ],
