    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'message_keys' => [
                ...
                'drug_partial_ap'            => 'Du schluckst die {item} hinunter. Die Droge scheint gepanscht zu sein, aber ihre Wirkung macht sich langsam bemerkbar: Schwindel, Übelkeit, Nasenbluten... Sie gibt Ihnen dennoch einen <strong>kleinen</strong> Energieschub... Übertreiben Sie es nicht!',   
