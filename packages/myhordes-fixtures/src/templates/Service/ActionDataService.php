    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'watercup_2' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_outside_or_exploring', 'must_have_micropur' ], 'result' => [ 'consume_micropur', 'consume_item', 'picto_ban_emanc', 'spawn_1_watercup' ], 'message_key' => 'item_clean_watercup' ],
                ...
                'jerrycan_4' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_outside', 'must_have_micropur_in', 'must_not_have_purifier', 'must_not_be_banished' ], 'result' => [ 'consume_micropur', 'consume_item', 'spawn_1_water', 'minus_1ap' ], 'message_key' => 'item_clean' ], //jerrycan + tablet outside town
                ...
                'jerrycan_4b' => [ 'label' => 'Reinigen (Wasser)', 'meta' => [ 'must_be_outside', 'must_have_micropur_in', 'must_be_banished' ], 'result' => [ 'consume_micropur', 'consume_item', 'spawn_1_water', 'minus_1ap'], 'message_key' => 'item_clean' ], //(shunned) jerrycan + tablet outside town
                ...
                'hero_generic_fs_xp'        => [ 'label' => 'Erfahrung teilen', 'tooltip' => 'Du gibst 5 Erfahrungspunkte aus, damit ein anderer Spieler 10 Erfahrungspunkte erhält.', 'confirm' => true, 'confirmMsg' => 'Möchtest du 5 Erfahrungspunkte ausgeben, damit {targetPlayer} 10 Erfahrungspunkte erhält? Hinweis: Pro Saison kannst du dem gleichen Spieler maximal 3x Erfahrung spenden.' ,'target' => ['type' => ItemTargetDefinition::ItemFriendshipXPType], 'meta' => [ 'not_yet_hero', 'can_use_friendship'], 'result' => [ 'hero_act', 'hero_sxp' ], 'message' => 'Du hast deine Erfahrung an {citizen} weitergegeben.' ],
                ...
                //'equip_bike_again' => [ 'label' => 'Anlegen', 'at00' => true, 'meta' => ['is_not_wounded_hands','bike_today','not_yet_bike_now','not_yet_bike_now_c','room_for_heavy_item'], 'result' => [ 'equip_item', 'status_tag_bike_now', 'status_tag_bike_today' ], 'message' => 'Mit diesen neuen Schuhen wird das Erkunden der Außenwelt ein Kinderspiel.' ],
