    ...
    public function process(array &$data): void
    {
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'watercan2_tl0watercan2_tl0'  => [ 'label' => 'Trinken', 'priority' => 3, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'not_role_ghoul', 'not_thirsty', 'drink_mesg',  'drink_tl0a', 'drink_tl0b' ], 'result' => [ 'contaminated_zone_infect', 'reset_thirst_counter', 'drink_ap_1',                'produce_watercan1' ], 'escort_message_key' => 'escort_water_drink', 'message_key' => 'water_drink' ],
