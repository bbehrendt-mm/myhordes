    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'home_pool'    => [ 'label' => 'Ein Bad nehmen', 'meta' => [ 'must_be_inside', 'must_have_pool', 'not_yet_home_pooled' ], 'result' => [ 'status_home_pool', 'status_good_smell' ], 'message' => 'Du springst ohne zu zögern in dieses große Bad. Das Chaos um dich herum existiert für dich nicht mehr und du spürst, dass du diese Nacht mit Gelassenheit verbringen wirst.' ],
