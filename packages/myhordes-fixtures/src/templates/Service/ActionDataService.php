    ...
    public function process(array &$data): void
    {
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'water_g'    => [ 'label' => 'Trinken', 'priority' => 1, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'is_not_wounded', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'consume_item' ], 'message_key' => 'water_drink_ghoul' ],
                ...
                'potion_g'           => [ 'label' => 'Trinken', 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'not_yet_immune', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'consume_item', ['group' => 'g_immune_98'], ], 'message' => 'Du hast soeben den mystischen Trank getrunken. Hoffen wir, dass dieser Schamane weiß, was er tut...' ],
                ...
                'potion_g_immune'    => [ 'label' => 'Trinken', 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'immune', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'consume_item', ['group' => 'g_immune_98'], ], 'message' => 'Tja, Vertrauen ist gut, Kontrolle ist besser... Ja, du wurdest bereits geschützt!' ],
                ...
                'watercan3_g'    => [ 'label' => 'Trinken', 'priority' => 4, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'is_not_wounded', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'produce_watercan2' ], 'message_key' => 'water_drink_ghoul' ],
                ...
                'watercan2_g'    => [ 'label' => 'Trinken', 'priority' => 3, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'is_not_wounded', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'produce_watercan1' ], 'message_key' => 'water_drink_ghoul' ],
                ...
                'watercan1_g'    => [ 'label' => 'Trinken', 'priority' => 2, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'role_ghoul', 'is_not_wounded', 'drink_mesg' ], 'result' => [ 'inflict_wound', 'produce_watercan0' ], 'message_key' => 'water_drink_ghoul' ],
