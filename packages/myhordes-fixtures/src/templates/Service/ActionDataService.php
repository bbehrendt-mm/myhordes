    ...
    public function process(array &$data, ?string $tag = null): void
    {
        ...
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                ...
                'home_survivalist_any' => [ 'label' => '"Wasser finden"', 'meta' => [ 'must_be_inside', 'min_3_ap', 'not_profession_survivalist', 'must_have_surv_building', 'surv_building_counter_below_1' ], 'result' => [ 'minus_3ap', 'status_count_surv', 'building_survivalist_a' ], 'message' => 'Sie haben es zunächst nicht geglaubt, aber nachdem Sie die halbierten Dosen überprüft haben, stellen Sie fest, dass sich etwas Wasser darin befindet. Wie sich herausstellt, wissen diese Einsiedler doch einiges! Du erhälst {items_spawn}.' ],
                'home_survivalist_pro' => [ 'label' => '"Wasser finden"', 'meta' => [ 'must_be_inside', 'min_3_ap', 'profession_survivalist', 'must_have_surv_building', 'surv_building_counter_below_1' ], 'result' => [ 'minus_3ap', 'status_count_surv', 'building_survivalist_b', [ 'group' => [ ['building_survivalist_c', 50], [ 'do_nothing', 50 ] ] ] ], 'message' => 'Einige Leute haben Ihr Wassergewinnung System verleumderisch geäußert, aber es ist offensichtlich, dass sie jetzt schweigen. Du erhälst {items_spawn}.' ],
