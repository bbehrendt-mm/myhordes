...
class RuinDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data): void
    {
        $data = array_merge_recursive($data, [
            ...
            // id 41
            'albi' => ["label" => "Albi Supermarkt",'icon' => 'albi',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 686, "empty" => 0.25, "drops" => [
                'drug_hero_#00' => 91,
                'meat_#00' => 91,
            ...
            // id 57
            'cave' => ["label" => "Alte Höhle",'icon' => 'cave',"camping" => 7,"min_dist" => 16, "max_dist" => 19, "chance" => 184, "empty" => 0.25, "drops" => [
                'money_#00' => 106,
                'machine_1_#00' => 26,
                'machine_3_#00' => 25,
                'chair_basic_#00' => 25,
            ...
            // id 3
            'pump' => ["label" => "Alte Hydraulikpumpe",'icon' => 'pump',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 401, "empty" => 0.25, "drops" => [
                'jerrycan_#00' => 331,
                'oilcan_#00' => 23,
                'metal_beam_#00' => 20,
                'tube_#00' => 18,
            ...
            // id 53
            'freight' => ["label" => "Alter Rangierbahnhof",'icon' => 'freight',"camping" => 7,"min_dist" => 10, "max_dist" => 13, "chance" => 464, "empty" => 0.25, "drops" => [
                'metal_#00' => 114,
                'wood2_#00' => 113,
                'chain_#00' => 52,
                'metal_beam_#00' => 36,
            ...
            // id 54
            'hospital' => ["label" => "Altes Feldkrankenhaus",'icon' => 'hospital',"camping" => 7,"min_dist" => 16, "max_dist" => 19, "chance" => 205, "empty" => 0.25, "drops" => [
                'drug_random_#00' => 67,
                'pharma_#00' => 39,
            ...
            // id 48
            'aerodrome' => ["label" => "Altes Flugfeld",'icon' => 'aerodrome',"camping" => 7,"min_dist" => 12, "max_dist" => 15, "chance" => 129, "empty" => 0.25, "drops" => [
                'metal_beam_#00' => 62,
                'electro_box_#00' => 28,
                'meca_parts_#00' => 24,
                'repair_one_#00' => 21,
            ...
            // id 8
            'police' => ["label" => "Altes Polizeipräsidium",'icon' => 'police',"camping" => 11,"min_dist" => 6, "max_dist" => 9, "chance" => 640, "empty" => 0.25, "drops" => [
                'drug_hero_#00' => 58,
                'taser_empty_#00' => 53,
                'repair_kit_#00' => 49,
            ...
            // id 10
            'bunker' => ["label" => "Atombunker",'icon' => 'bunker',"camping" => 15,"min_dist" => 10, "max_dist" => 13, "chance" => 499, "empty" => 0.25, "drops" => [
                'drug_hero_#00' => 127,
                'tagger_#00' => 66,
                'chest_#00' => 60,
                'repair_kit_#00' => 54,
            ...
            // id 38
            'cafe' => ["label" => "Atomic Cafe",'icon' => 'cafe',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 320, "empty" => 0.25, "drops" => [
                'coffee_#00' => 55,
                'food_chick_#00' => 55,
                'pet_rat_#00' => 30,
                'rhum_#00' => 27,
            ...
            // id 61
            'autobahn' => ["label" => "Autobahnraststätte",'icon' => 'autobahn',"camping" => 7,"min_dist" => 8, "max_dist" => 11, "chance" => 460, "empty" => 0.25, "drops" => [
                'pet_rat_#00' => 32,
                'food_bar2_#00' => 25,
                'food_tarte_#00' => 23,
                'food_bar1_#00' => 22,
            ...
            // id 7
            'cars' => ["label" => "Autowracks",'icon' => 'cars',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 304, "empty" => 0.25, "drops" => [
                'metal_#00' => 112,
                'plate_raw_#00' => 24,
                'chest_#00' => 21,
                'tube_#00' => 21,
            ...
            // id 62
            'bar2' => ["label" => "Bar der verlorenen Hoffnungen",'icon' => 'bar2',"camping" => 9,"min_dist" => 21, "max_dist" => 28, "chance" => 41, "empty" => 0.25, "drops" => [
                'pet_dog_#00' => 10,
                'rhum_#00' => 9,
                'rp_book_#00' => 7,
                'rp_sheets_#00' => 4,
            ...
            // id 19
            'obi' => ["label" => "Baumarkt",'icon' => 'obi',"camping" => 7,"min_dist" => 5, "max_dist" => 8, "chance" => 409, "empty" => 0.25, "drops" => [
                'repair_kit_#00' => 74,
                'chest_#00' => 36,
                'chest_tools_#00' => 33,
                'plate_raw_#00' => 31,
            ...
            // id 43
            'container' => ["label" => "Baustellencontainer",'icon' => 'container',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 475, "empty" => 0.25, "drops" => [
                'mecanism_#00' => 31,
                'trestle_#00' => 26,
                'jerrycan_#00' => 25,
                'chain_#00' => 24,
            ...
            // id 23
            'doner' => ["label" => "Dönerbude Utsel-Brutzel",'icon' => 'doner',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 181, "empty" => 0.25, "drops" => [
                'meat_#00' => 15,
                'vegetable_#00' => 10,
                'jerrycan_#00' => 6,
                'chest_food_#00' => 3,
            ...
            // id 24
            'duke' => ["label" => "Dukes Villa",'icon' => 'duke',"camping" => 7,"min_dist" => 12, "max_dist" => 15, "chance" => 148, "empty" => 0.25, "drops" => [
                'drug_hero_#00' => 40,
                'rhum_#00' => 27,
                'vibr_empty_#00' => 24,
            ...
            // id 13
            'woods' => ["label" => "Dunkler Hain",'icon' => 'woods',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 70, "empty" => 0.25, "drops" => [
                'wood_bad_#00' => 28,
                'hmeat_#00' => 3,
                'pet_rat_#00' => 2,
                'vegetable_#00' => 2,
            ...
            // id 52
            'mine' => ["label" => "Eingestürzte Mine",'icon' => 'mine',"camping" => 7,"min_dist" => 12, "max_dist" => 15, "chance" => 341, "empty" => 0.25, "drops" => [
                'powder_#00' => 191,
                'explo_#00' => 39,
                'deto_#00' => 37,
                'mecanism_#00' => 30,
            ...
            // id 30
            'quarry' => ["label" => "Eingestürzter Steinbruch",'icon' => 'quarry',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 71, "empty" => 0.25, "drops" => [
                'concrete_#00' => 9,
                'chest_tools_#00' => 9,
                'plate_raw_#00' => 7,
                'metal_beam_#00' => 6,
            ...
            // id 59
            'ufo' => ["label" => "Ein seltsames kreisförmiges Gerät",'icon' => 'ufo',"camping" => 7,"min_dist" => 21, "max_dist" => 28, "chance" => 15, "empty" => 0.25, "drops" => [
                'metal_bad_#00' => 6,
                'plate_raw_#00' => 2,
                'iphone_#00' => 1,
            ...
            // id 40
            'ekea' => ["label" => "E-KEA",'icon' => 'ekea',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 242, "empty" => 0.25, "drops" => [
                'deco_box_#00' => 49,
            ...
            // id 28
            'tomb' => ["label" => "Familiengrab",'icon' => 'tomb',"camping" => 2,"min_dist" => 3, "max_dist" => 6, "chance" => 68, "empty" => 0.25, "drops" => [
                'hmeat_#00' => 24,
                'gun_#00' => 17,
                'machine_gun_#00' => 5,
                'pet_rat_#00' => 4,
            ...
            // id 18
            'mczombie' => ["label" => "Fast Food Restaurant",'icon' => 'mczombie',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 710, "empty" => 0.25, "drops" => [
                'coffee_#00' => 178,
                'meat_#00' => 94,
                'pharma_#00' => 28,
                'hmeat_#00' => 27,
            ...
            // id 2
            'plane' => ["label" => "Flugzeugwrack",'icon' => 'plane',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 155, "empty" => 0.25, "drops" => [
                'tube_#00' => 13,
                'chest_#00' => 13,
                'metal_beam_#00' => 10,
                'plate_raw_#00' => 9,
            ...
            // id 44
            'shed' => ["label" => "Gartenhaus",'icon' => 'shed',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 624, "empty" => 0.25, "drops" => [
                'digger_#00' => 136,
                'electro_box_#00' => 62,
            ...
            // id 5
            'supermarket' => ["label" => "Geplünderte Mall",'icon' => 'supermarket',"camping" => 5,"min_dist" => 4, "max_dist" => 7, "chance" => 466, "empty" => 0.25, "drops" => [
                'cart_part_#00' => 54,
                'meat_#00' => 48,
            ...
            // id 27
            'cave2' => ["label" => "Höhle",'icon' => 'cave2',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 73, "empty" => 0.25, "drops" => [
                'hmeat_#00' => 13,
                'chest_#00' => 13,
                'chest_tools_#00' => 9,
                'chest_citizen_#00' => 8,
            ...
            // id 37
            'cemetary' => ["label" => "Indianerfriedhof",'icon' => 'cemetary',"camping" => -5,"min_dist" => 3, "max_dist" => 6, "chance" => 181, "empty" => 0.25, "drops" => [
                'bone_#00' => 115,
                'bone_meat_#00' => 13,
                'hmeat_#00' => 7,
                'pet_rat_#00' => 3,
            ...
            // id 11
            'fair' => ["label" => "Jahrmarktstand",'icon' => 'fair',"camping" => 7,"min_dist" => 5, "max_dist" => 8, "chance" => 215, "empty" => 0.25, "drops" => [
            ...
            // id 12
            'house' => ["label" => "Kleines Haus",'icon' => 'house',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 381, "empty" => 0.25, "drops" => [
                'pharma_#00' => 50,
                'water_#00' => 35,
                'rustine_#00' => 31,
                'food_bag_#00' => 29,
            ...
            // id 21
            'water' => ["label" => "Kleinwasserkraftwerk",'icon' => 'water',"camping" => 7,"min_dist" => 5, "max_dist" => 8, "chance" => 472, "empty" => 0.25, "drops" => [
                'jerrycan_#00' => 300,
                'water_#00' => 21,
            ...
            // id 6
            'lab' => ["label" => "Kosmetiklabor",'icon' => 'lab',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 180, "empty" => 0.25, "drops" => [
                'pharma_#00' => 30,
                'pet_rat_#00' => 27,
                'meat_#00' => 17,
                'pet_cat_#00' => 7,
            ...
            // id 36
            'ambulance' => ["label" => "Krankenwagen",'icon' => 'ambulance',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 183, "empty" => 0.25, "drops" => [
                'drug_random_#00' => 57,
                'pharma_#00' => 46,
                'bandage_#00' => 17,
            ...
            // id 47
            'warehouse' => ["label" => "Lagerhalle",'icon' => 'warehouse',"camping" => 7,"min_dist" => 15, "max_dist" => 18, "chance" => 219, "empty" => 0.25, "drops" => [
                'rsc_pack_1_#00' => 86,
                'chest_food_#00' => 84,
                'chest_tools_#00' => 67,
                'home_box_#00' => 25,
            ...
            // id 14
            'carpark' => ["label" => "Leeres Parkhaus",'icon' => 'carpark',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 335, "empty" => 0.25, "drops" => [
                'metal_beam_#00' => 119,
                'repair_one_#00' => 38,
                'trestle_#00' => 33,
                'chest_#00' => 32,
            ...
            // id 58
            'tank' => ["label" => "Liegengebliebener Kampfpanzer",'icon' => 'tank',"camping" => 9,"min_dist" => 21, "max_dist" => 28, "chance" => 83, "empty" => 0.25, "drops" => [
                'chain_#00' => 20,
                'home_def_#00' => 16,
                'mecanism_#00' => 14,
                'powder_#00' => 9,
            ...
            // id 51
            'motel' => ["label" => "Motel 'Dusk'",'icon' => 'motel',"camping" => 7,"min_dist" => 12, "max_dist" => 15, "chance" => 292, "empty" => 0.25, "drops" => [
                'door_carpet_#00' => 8,
                'chest_#00' => 5,
                'carpet_#00' => 4,
                'chest_food_#00' => 2,
            ...
            // id 55
            'army' => ["label" => "Militärischer Wachposten",'icon' => 'army',"camping" => 9,"min_dist" => 16, "max_dist" => 19, "chance" => 212, "empty" => 0.25, "drops" => [
                'coffee_#00' => 68,
                'machine_gun_#00' => 62,
                'gun_#00' => 57,
                'chest_food_#00' => 56,
            ...
            // id 46
            'post' => ["label" => "Postfiliale",'icon' => 'post',"camping" => 7,"min_dist" => 8, "max_dist" => 11, "chance" => 177, "empty" => 0.25, "drops" => [
                'rp_letter_#00' => 41,
                'postal_box_#00' => 39,
            ...
            // id 32
            'trench' => ["label" => "Schützengraben",'icon' => 'trench',"camping" => 9,"min_dist" => 5, "max_dist" => 8, "chance" => 216, "empty" => 0.25, "drops" => [
                'concrete_#00' => 104,
            ...
            // id 45
            'dll' => ["label" => "Stadtbücherei",'icon' => 'dll',"camping" => 7,"min_dist" => 6, "max_dist" => 9, "chance" => 204, "empty" => 0.25, "drops" => [
                'deco_box_#00' => 77,
                'rp_scroll_#00' => 16,
                'rp_book_#00' => 13,
                'rp_sheets_#00' => 11,
            ...
            // id 42
            'emma' => ["label" => "Tante Emma Laden",'icon' => 'emma',"camping" => 7,"min_dist" => 8, "max_dist" => 11, "chance" => 913, "empty" => 0.25, "drops" => [
                'cigs_#00' => 77,
                'jerrycan_#00' => 75,
                'can_#00' => 69,
                'drug_#00' => 69,
            ...
            // id 56
            'mayor' => ["label" => "Truck 'Rathaus auf Rädern'",'icon' => 'mayor',"camping" => 7,"min_dist" => 16, "max_dist" => 19, "chance" => 81, "empty" => 0.25, "drops" => [
            ...
            // id 35
            'lkw' => ["label" => "Umgekippter Laster",'icon' => 'lkw',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 177, "empty" => 0.25, "drops" => [
                'chest_food_#00' => 58,
                'chest_tools_#00' => 22,
                'wrench_#00' => 8,
            ...
            // id 16
            'school' => ["label" => "Verbrannte Grundschule",'icon' => 'school',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 165, "empty" => 0.25, "drops" => [
                'hmeat_#00' => 42,
            ...
            // id 49
            'office' => ["label" => "Verfallenes Bürogebäude",'icon' => 'office',"camping" => 7,"min_dist" => 10, "max_dist" => 13, "chance" => 519, "empty" => 0.25, "drops" => [
                'mecanism_#00' => 82,
                'chair_basic_#00' => 74,
                'electro_box_#00' => 72,
                'money_#00' => 39,
            ...
            // id 4
            'villa' => ["label" => "Verfallene Villa",'icon' => 'villa',"camping" => 7,"min_dist" => 3, "max_dist" => 6, "chance" => 338, "empty" => 0.25, "drops" => [
                'can_#00' => 63,
                'pile_#00' => 32,
            ...
            // id 15
            'construction' => ["label" => "Verlassene Baustelle",'icon' => 'construction',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 481, "empty" => 0.25, "drops" => [
                'metal_beam_#00' => 103,
                'repair_kit_#00' => 64,
                'plate_raw_#00' => 51,
                'concrete_#00' => 50,
            ...
            // id 60
            'well' => ["label" => "Verlassener Brunnen",'icon' => 'well',"camping" => 1,"min_dist" => 17, "max_dist" => 20, "chance" => 221, "empty" => 0.25, "drops" => [
                'water_#00' => 121,
            ...
            // id 39
            'silo' => ["label" => "Verlassene Silos",'icon' => 'silo',"camping" => 7,"min_dist" => 8, "max_dist" => 11, "chance" => 482, "empty" => 0.25, "drops" => [
                'jerrycan_#00' => 321,
            ...
            // id 31
            'street' => ["label" => "Versperrte Straße",'icon' => 'street',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 42, "empty" => 0.25, "drops" => [
            ...
            // id 29
            'park' => ["label" => "Verwilderter Park",'icon' => 'park',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 102, "empty" => 0.25, "drops" => [
            ...
            // id 34
            'warehouse2' => ["label" => "Warenlager",'icon' => 'warehouse2',"camping" => 7,"min_dist" => 2, "max_dist" => 5, "chance" => 181, "empty" => 0.25, "drops" => [
                'chest_food_#00' => 43,
            ...
            // id 50
            'tent' => ["label" => "Zelt eines Bürgers",'icon' => 'tent',"camping" => 11,"min_dist" => 12, "max_dist" => 15, "chance" => 202, "empty" => 0.25, "drops" => [
                'chest_hero_#00' => 72,
                'lamp_#00' => 36,
                'banned_note_#00' => 36,
                'chest_food_#00' => 33,
            ...
            // id 17
            'pharma' => ["label" => "Zerstörte Apotheke",'icon' => 'pharma',"camping" => 7,"min_dist" => 4, "max_dist" => 7, "chance" => 458, "empty" => 0.25, "drops" => [
                'pharma_#00' => 316,
                'cyanure_#00' => 37,
                'xanax_#00' => 30,
                'drug_#00' => 28,
            ...
            // id 9
            'bar' => ["label" => "ZomBIER Bar",'icon' => 'bar',"camping" => 7,"min_dist" => 5, "max_dist" => 8, "chance" => 432, "empty" => 0.25, "drops" => [
                'rhum_#00' => 76,
                'meat_#00' => 60,
                'food_bag_#00' => 26,
                'pet_rat_#00' => 22,
