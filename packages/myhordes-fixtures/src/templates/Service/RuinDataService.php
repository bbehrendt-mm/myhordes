        ...
        $data = array_replace_recursive($data, [
            ...
            "albi" => [
                ...
                "drops" => [
                    "drug_hero_#00" => 16,
                    "meat_#00" => 16,
                    "food_noodles_hot_#00" => 16,
                    "vegetable_tasty_#00" => 16,
                    "electro_box_#00" => 4,
                    "powder_#00" => 3,
                    "food_bag_#00" => 3,
                    "door_carpet_#00" => 3,
            ...
            // id 62
            "bar2" => [
                "label" => "Bar der verlorenen Hoffnungen",
                "icon" => "bar2",
                "camping" => 20,
                "min_dist" => 21,
                "max_dist" => 28,
            ...
            // id 30
            "quarry" => [
                "label" => "Eingestürzter Steinbruch",
                "icon" => "quarry",
                "camping" => 10,
                "min_dist" => 3,
                "max_dist" => 6,
            ...
            // id 59
            "ufo" => [
                "label" => "Ein seltsames kreisförmiges Gerät",
                "icon" => "ufo",
                "camping" => 10,
                "min_dist" => 21,
                "max_dist" => 28,
            ...
            // id 58
            "tank" => [
                "label" => "Liegengebliebener Kampfpanzer",
                "icon" => "tank",
                "camping" => 20,
                "min_dist" => 21,
                "max_dist" => 28,
            ...
            // id 55
            "army" => [
                "label" => "Militärischer Wachposten",
                "icon" => "army",
                "camping" => 20,
                "min_dist" => 16,
                "max_dist" => 19,
            ...
            "post" => [
                ...
                "drops" => [
                    ...
                    "postal_box_#01_xmas_alt_1" => [
                        "item" => "postal_box_#01",
                        "count" => 3,
                        "mod" => DropMod::EventChristmasAlt1
                    ],
                    "postal_box_xl_#00_xmas_alt_2" => [
                        "item" => "postal_box_xl_#00",
                        "count" => 3,
                        "mod" => DropMod::EventChristmasAlt2
                    ],
                ],
            ...
            // id 56
            "mayor" => [
                "label" => "Truck 'Rathaus auf Rädern'",
                "icon" => "mayor",
                "camping" => 10,
                "min_dist" => 16,
                "max_dist" => 19,
            ...
            // id 22
            "guns" => [
                "label" => "Waffengeschäft Guns'n'Zombies",
                "icon" => "guns",
                "camping" => 10,
                "min_dist" => 5,
                "max_dist" => 8,
