...
class ItemPropertyDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data, ?string $tag = null): void
    {
        $content = [
            ...
            'can_opener_#00'             => [ 'weapon', 'can_opener', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'screw_#00'                  => [ 'weapon', 'can_opener', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'swiss_knife_#00'            => [ 'weapon', 'can_opener', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'wrench_#00'                 => [ 'weapon', 'box_opener', 'parcel_opener', 'hero_dog_fetch' ],
            'cutter_#00'                 => [ 'weapon', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'small_knife_#00'            => [ 'weapon', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'bone_#00'                   => [ 'weapon', 'box_opener', 'parcel_opener', 'hero_dog_fetch' ],
            'cutcut_#00'                 => [ 'impoundable', 'weapon', 'box_opener', 'esc_fixed', 'nw_armory', 'parcel_opener' ],
            'hurling_stick_#00'          => [ 'weapon', 'box_opener', 'nw_armory', 'parcel_opener' ],
            'chair_basic_#00'            => [ 'box_opener', 'nw_ikea', 'parcel_opener' ],
            'chair_#00'                  => [ 'nw_ikea' ],
            'staff_#00'                  => [ 'weapon', 'box_opener', 'nw_armory', 'parcel_opener', 'hero_dog_fetch' ],
            'chain_#00'                  => [ 'impoundable', 'weapon', 'box_opener', 'esc_fixed', 'nw_armory', 'parcel_opener' ],
            ...
            'mixergun_#00'               => [ 'weapon' ],
            'chainsaw_#00'               => [ 'impoundable', 'weapon', 'box_opener', 'esc_fixed', 'nw_armory', 'parcel_opener' ],
            'chainsaw_empty_#00'         => [ 'impoundable' ],
            'chainsaw_part_#00'          => [ 'impoundable' ],
            'taser_#00'                  => [ 'weapon', 'nw_impact_cumul' ],
            ...
            'kalach_#00'                 => [ 'impoundable', 'nw_shooting', 'esc_fixed' ],
            ...
            'jerrycan_#00'               => [ 'impoundable', 'hero_find_lucky', 'hero_find_lucky2', 'hero_find_lucky3' ],
            'knife_#00'                  => [ 'impoundable', 'weapon', 'box_opener', 'esc_fixed', 'nw_armory', 'parcel_opener' ],
            'lawn_#00'                   => [ 'weapon', 'nw_armory' ],
            'torch_off_#00'              => [ 'weapon' ],
            'iphone_#00'                 => [ 'weapon' ],
            'machine_1_#00'              => [ 'esc_fixed', 'nw_ikea', 'impoundable' ],
            'machine_2_#00'              => [ 'esc_fixed', 'nw_ikea', 'impoundable' ],
            'machine_3_#00'              => [ 'esc_fixed', 'nw_ikea', 'impoundable' ],
            'disinfect_#00'              => [ 'impoundable', 'drug', 'hero_find_lucky3' ],
            'drug_#00'                   => [ 'can_poison', 'impoundable', 'drug', 'hero_find_lucky3', 'hero_dog_fetch' ],
            'drug_hero_#00'              => [ 'impoundable', 'drug', 'esc_fixed' ],
            'drug_random_#00'            => [ 'drug' ],
            'beta_drug_bad_#00'          => [ 'drug' ],
            'beta_drug_#00'              => [ 'impoundable', 'drug' ],
            'xanax_#00'                  => [ 'drug', 'hero_find_lucky', 'hero_find_lucky2', 'hero_find_lucky3' ],
            'drug_water_#00'             => [ 'drug' ],
            ...
            'fungus_#00'                 => [ 'food', 'inedible', 'can_cook', 'lure' ],
            'radio_on_#00'               => [ 'impoundable', 'nw_ikea' ],
            'water_#00'                  => [ 'impoundable', 'can_poison', 'hero_find', 'esc_fixed', 'hero_find_lucky',  'found_poisoned', 'is_water', 'hero_find_lucky2', 'hero_find_lucky3', 'hero_dog_fetch' ],
            'can_open_#00'               => [ 'can_poison', 'food', 'can_cook', 'single_use', 'hero_dog_fetch', 'lure' ],
            'vegetable_#00'              => [ 'can_poison', 'food', 'can_cook', 'single_use', 'hero_dog_fetch', 'lure' ],
            'fruit_#00'                  => [ 'can_poison', 'food', 'can_cook', 'single_use', 'lure' ],
            ...
            'potion_#00'                 => [ 'impoundable', 'is_water', 'esc_fixed' ],
            'lock_#00'                   => [ 'lock' ],
            'dfhifi_#01'                 => [ 'lock' ],
            'pile_#00'                   => [ 'impoundable', 'hero_find', 'hero_find_lucky', 'hero_find_lucky2', 'hero_find_lucky3' ],
            'food_bag_#00'               => [ 'hero_find', 'hero_dog_fetch' ],
            'rsc_pack_3_#00'             => [ 'impoundable', 'hero_find_lucky', 'hero_find_lucky2', 'hero_find_lucky3' ],
            'rsc_pack_2_#00'             => [ 'impoundable', 'hero_find' ],
            'rsc_pack_1_#00'             => [ 'impoundable' ],
            'bretz_#00'                  => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'undef_#00'                  => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'dish_#00'                   => [ 'food', 'single_use', 'lure' ],
            'chama_#00'                  => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_bar1_#00'              => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_bar2_#00'              => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_bar3_#00'              => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_biscuit_#00'           => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_chick_#00'             => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_pims_#00'              => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_tarte_#00'             => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_sandw_#00'             => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_noodles_#00'           => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'hmeat_#00'                  => [ 'food', 'can_cook', 'single_use', 'nw_trebuchet', 'lure' ],
            'bone_meat_#00'              => [ 'food', 'can_cook', 'single_use', 'nw_trebuchet', 'lure' ],
            'cadaver_#00'                => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'food_noodles_hot_#00'       => [ 'food', 'esc_fixed', 'single_use', 'lure' ],
            'meat_#00'                   => [ 'food', 'esc_fixed', 'hero_find_lucky', 'single_use', 'hero_find_lucky2', 'hero_find_lucky3', 'lure' ],
            'vegetable_tasty_#00'        => [ 'food', 'esc_fixed', 'single_use', 'lure' ],
            'dish_tasty_#00'             => [ 'impoundable', 'food', 'esc_fixed', 'single_use', 'lure' ],
            'food_candies_#00'           => [ 'food', 'esc_fixed', 'single_use', 'lure' ],
            'chama_tasty_#00'            => [ 'food', 'esc_fixed', 'single_use', 'lure' ],
            ...
            'home_box_#00'               => [ 'impoundable' ],
            'home_box_xl_#00'            => [ 'impoundable' ],
            'lamp_#00'                   => [ 'nw_ikea' ],
            'lamp_on_#00'                => [ 'nw_ikea', 'prevent_night', 'nw_impact_cumul' ],
            'music_#00'                  => [ 'nw_ikea' ],
            'distri_#00'                 => [ 'nw_ikea' ],
            'guitar_#00'                 => [ 'impoundable', 'nw_ikea' ],
            'bureau_#00'                 => [ 'nw_ikea' ],
            'rlaunc_#00'                 => [ 'impoundable', 'nw_armory', 'esc_fixed' ],
            'repair_one_#00'             => [ 'impoundable', 'hero_find_lucky', 'hero_find_lucky2' ],
            'electro_box_#00'            => [ 'hero_find_lucky', 'hero_find_lucky2', 'hero_find_lucky3' ],
            'christmas_candy_#00'        => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'omg_this_will_kill_you_#00' => [ 'can_cook', 'lure' ],
            'chudol_#00'                 => [ 'prevent_terror' ],
            'maglite_1_#00'              => [ 'prevent_night' ],
            'maglite_2_#00'              => [ 'prevent_night' ],
            'wood_xmas_#00'              => [ 'food', 'single_use', 'lure' ],
            'fence_#00'                  => [ 'impoundable' ],
            'engine_#00'                 => [ 'impoundable' ],
            'engine_part_#00'            => [ 'impoundable' ],
            'repair_kit_#00'             => [ 'impoundable', 'hero_find_lucky3' ],
            ...
            'shoe_#00'                   => ['single_use'],
            'bike_#00'                   => ['single_use'],
            'quantum_#00'                => [ 'hero_find_lucky3' ],
            'lens_#00'                   => [ 'hero_find_lucky2', 'hero_find_lucky3' ],
            'deco_box_#00'               => ['nw_ikea', 'hero_find_lucky2', 'hero_find_lucky3'],
            'coffee_#00'				 => ['nw_impact_cumul', 'hero_find_lucky2', 'hero_find_lucky3', 'lure'],
            'pumpkin_tasty_#00'          => ['impoundable', 'food', 'single_use', 'lure'],
            'moldy_food_subpart_#00'     => [ 'single_use', 'lure' ],
            'moldy_food_spicy_#00'       => [ 'food', 'can_cook', 'single_use', 'lure' ],
            'moldy_food_#00'             => [ 'food', 'single_use', 'lure' ],
