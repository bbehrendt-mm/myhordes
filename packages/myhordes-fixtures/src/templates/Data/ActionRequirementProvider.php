...
class ActionRequirementProvider
{
    public static function create(array $data): RequirementsDataContainer {
        ...
        $requirement_container->add()->identifier('must_be_at_buried_ruin')->type( Requirement::CrossOnFail )->add( (new LocationRequirement())->beyond(true)->atBuriedRuin(true) )->text('Dir fällt kein Grund ein, dies zu tun...')->commit();
