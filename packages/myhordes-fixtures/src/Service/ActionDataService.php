...
class ActionDataService implements FixtureProcessorInterface {
    ...
    public function process(array &$data): void
    {
        $data = array_merge_recursive($data, [
            ...
            'actions' => [
                'water_tl0'  => [ 'label' => 'Trinken', 'priority' => 1, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'not_role_ghoul', 'no_full_ap', 'drink_mesg',  'drink_tl0a', 'drink_tl0b' ], 'result' => ['contaminated_zone_infect', 'reset_thirst_counter', 'drink_ap_1',                'consume_item' ], 'escort_message_key' => 'escort_water_drink', 'message_key' => 'water_drink' ],
                ...
                'watercan3_tl0'  => [ 'label' => 'Trinken', 'priority' => 4, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'not_role_ghoul', 'no_full_ap', 'drink_mesg',  'drink_tl0a', 'drink_tl0b' ], 'result' => [ 'contaminated_zone_infect', 'reset_thirst_counter', 'drink_ap_1',                'produce_watercan2' ], 'escort_message_key' => 'escort_water_drink', 'message_key' => 'water_drink' ],
                ...
                'watercan2_tl0'  => [ 'label' => 'Trinken', 'priority' => 3, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'not_role_ghoul', 'no_full_ap', 'drink_mesg',  'drink_tl0a', 'drink_tl0b' ], 'result' => [ 'contaminated_zone_infect', 'reset_thirst_counter', 'drink_ap_1',                'produce_watercan1' ], 'escort_message_key' => 'escort_water_drink', 'message_key' => 'water_drink' ],
                ...
                'watercan1_tl0'  => [ 'label' => 'Trinken', 'priority' => 2, 'cover' => true, 'at00' => true, 'poison' => ItemAction::PoisonHandlerConsume, 'meta' => [ 'not_role_ghoul', 'no_full_ap', 'drink_mesg',  'drink_tl0a', 'drink_tl0b' ], 'result' => [ 'contaminated_zone_infect', 'reset_thirst_counter', 'drink_ap_1',                'produce_watercan0' ], 'escort_message_key' => 'escort_water_drink', 'message_key' => 'water_drink' ],
