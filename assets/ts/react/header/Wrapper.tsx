...
const HordesStandaloneAppPopupWrapper = (props: mountProps) => {
...
const App = ({app, onClose, signalUpdate}: {app: ExternalApp|null, onClose: () => void, signalUpdate: () => void}) => {
    const globals = useContext(Globals)
