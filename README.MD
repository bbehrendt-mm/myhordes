...
All files into folder `assets/img` are the proprety of Motion-Twin, and are under [CC BY-NC-SA 4.0 license](license_url_et).
The rest of the project, is under [AGPL license](license_url_et).
