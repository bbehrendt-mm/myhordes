...
class RecipeFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    protected static $recipe_data = [
        'ws001' => ['type' => Recipe::WorkshopType, 'in' => 'repair_kit_part_#00', 'out' => 'repair_kit_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws002' => ['type' => Recipe::WorkshopType, 'in' => 'can_#00',             'out' => 'can_open_#00', 'action' => 'Öffnen', 'picto' => 'r_refine_#00'],
        'ws003' => ['type' => Recipe::WorkshopType, 'in' => 'plate_raw_#00',       'out' => 'plate_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws004' => ['type' => Recipe::WorkshopType, 'in' => 'wood_log_#00',        'out' => 'wood2_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws005' => ['type' => Recipe::WorkshopType, 'in' => 'wood_bad_#00',        'out' => 'wood2_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws006' => ['type' => Recipe::WorkshopType, 'in' => 'wood2_#00',           'out' => 'wood_beam_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws007' => ['type' => Recipe::WorkshopType, 'in' => 'wood_beam_#00',       'out' => 'wood2_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws008' => ['type' => Recipe::WorkshopType, 'in' => 'metal_bad_#00',       'out' => 'metal_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws009' => ['type' => Recipe::WorkshopType, 'in' => 'metal_#00',           'out' => 'metal_beam_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws010' => ['type' => Recipe::WorkshopType, 'in' => 'metal_beam_#00',      'out' => 'metal_#00', 'action' => 'Wandeln', 'picto' => 'r_refine_#00'],
        'ws011' => ['type' => Recipe::WorkshopType, 'in' => 'electro_box_#00',     'out' => [ 'pile_#00', 'pilegun_empty_#00', 'electro_#00', 'meca_parts_#00', 'tagger_#00', 'deto_#00' ], 'action' => 'Zerlegen', 'picto' => 'r_refine_#00' ],
        'ws012' => ['type' => Recipe::WorkshopType, 'in' => 'mecanism_#00',        'out' => [ 'metal_#00', 'tube_#00', 'metal_bad_#00', 'meca_parts_#00' ], 'action' => 'Zerlegen', 'picto' => 'r_refine_#00' ],
        'ws013' => ['type' => Recipe::WorkshopType, 'in' => 'chest_#00',           'out' => [ 'drug_#00', 'bandage_#00', 'pile_#00', 'pilegun_empty_#00', 'vodka_de_#00', 'pharma_#00', 'explo_#00', 'lights_#00', 'drug_hero_#00', 'rhum_#00' ], 'action' => 'Öffnen', 'picto' => 'r_refine_#00' ],
        'ws014' => ['type' => Recipe::WorkshopType, 'in' => 'chest_xl_#00',        'out' => [ 'watergun_opt_part_#00', 'pilegun_upkit_#00', 'pocket_belt_#00', 'cutcut_#00', 'chainsaw_part_#00', 'mixergun_part_#00', 'big_pgun_part_#00', 'lawn_part_#00' ], 'action' => 'Öffnen', 'picto' => 'r_refine_#00' ],
        'ws015' => ['type' => Recipe::WorkshopType, 'in' => 'chest_tools_#00',     'out' => [ 'pile_#00', 'meca_parts_#00', 'rustine_#00', 'tube_#00', 'pharma_#00', 'explo_#00', 'lights_#00' ], 'action' => 'Öffnen', 'picto' => 'r_refine_#00' ],
        'ws016' => ['type' => Recipe::WorkshopType, 'in' => 'chest_food_#00',      'out' => [ 'food_bag_#00', 'can_#00', 'meat_#00', 'hmeat_#00', 'vegetable_#00' ], 'action' => 'Öffnen', 'picto' => 'r_refine_#00' ],
        'ws017' => ['type' => Recipe::WorkshopType, 'in' => 'deco_box_#00',        'out' => [ 'door_#00', 'chair_basic_#00', 'trestle_#00', 'table_#00', 'chair_#00' ], 'action' => 'Öffnen', 'picto' => 'r_refine_#00' ],
