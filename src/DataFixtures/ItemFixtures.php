...
class ItemFixtures extends Fixture
{
    ...
    public static $item_prototype_data = [
        ...
        ['label'=>'Großer knuddeliger Kater','icon'=>'pet_cat','category'=>'root_weapon','deco'=>5,'heavy'=>false],                              // -- Out
        ...
        ['label'=>'PC-Gehäuse','icon'=>'pc','category'=>'root_weapon','deco'=>3,'heavy'=>true],                                                  // -- Out
        ...
        ['label' => 'Feuerwerkskiste','icon' => 'firework_box','category' => 'root_ein','deco' => 3,'heavy' => true],                                 // In Out
    ...
    public static $item_prototype_properties = [
        ...
        'can_open_#00'     => [ 'can_poison', 'food' ],
        'vegetable_#00'    => [ 'can_poison', 'food' ],
        'fruit_#00'        => [ 'can_poison', 'food' ],
        ...
        'food_bar2_#00'       => [ 'food' ],
        'food_bar3_#00'       => [ 'food' ],
        'food_biscuit_#00'    => [ 'food' ],
        'food_chick_#00'      => [ 'food' ],
        'food_pims_#00'       => [ 'food' ],
        'food_tarte_#00'      => [ 'food' ],
        'food_sandw_#00'      => [ 'food' ],
        'food_noodles_#00'    => [ 'food' ],
        'hmeat_#00'           => [ 'food' ],
        'bone_meat_#00'       => [ 'food' ],
        'cadaver_#00'         => [ 'food' ],
