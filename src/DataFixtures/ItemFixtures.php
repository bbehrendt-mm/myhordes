...
class ItemFixtures extends Fixture
{
    ...
    public static $item_prototype_properties = [
        ...
        'torch_#00'                  => [ 'impoundable', 'defence', 'weapon', 'nw_ikea', 'nw_armory', 'prevent_night', 'deco' ],
        ...
        'bgrenade_#00'               => [ 'weapon', 'esc_fixed', 'nw_armory', 'nw_shooting' ],
        ...
        'water_can_3_#00'            => [ 'esc_fixed', 'is_water' ],
        'water_can_2_#00'            => [ 'esc_fixed', 'is_water' ],
        'water_can_1_#00'            => [ 'esc_fixed', 'is_water' ],
        'water_cup_#00'              => [ 'is_water' ],
        'potion_#00'                 => [ 'is_water' ],
        'lock_#00'                   => [ 'lock' ],
        'dfhifi_#01'                 => [ 'lock' ],
        ...
        'pet_cat_#00'                => [ 'pet', 'esc_fixed', 'nw_trebuchet' ],
