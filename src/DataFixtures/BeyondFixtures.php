...
class BeyondFixtures extends Fixture implements DependentFixtureInterface
{
    public static $zone_class_data = [
        ["label"=>"Abgelegenes Haus","camping"=>7,"drops"=> [
        ...
        ["label"=>"Albi Supermarkt","camping"=>7,"drops"=>[
        ...
        ["label"=>"Alte Höhle","camping"=>7,"drops"=>[
        ...
        ["label"=>"Alte Hydraulikpumpe","camping"=>7,"drops"=>[
        ...
        ["label"=>"Alter Fahrradverleih","camping"=>7,"drops"=>[
        ...
        ["label"=>"Alter Rangierbahnhof","camping"=>7,"drops"=>[
        ...
        ["label"=>"Altes Feldkrankenhaus","camping"=>7,"drops"=>[
        ...
        ["label"=>"Altes Flugfeld","camping"=>7,"drops"=>[
        ...
        ["label"=>"Altes Polizeipräsidium","camping"=>11,"drops"=>[
        ...
        ["label"=>"Atombunker","camping"=>15,"drops"=>[
        ...
        ["label"=>"Atomic Cafe","camping"=>7,"drops"=>[
        ...
        ["label"=>"Autobahnraststätte","camping"=>7,"drops"=>[
        ...
        ["label"=>"Autowracks","camping"=>7,"drops"=>[
        ...
        ["label"=>"Bar der verlorenen Hoffnungen","camping"=>9,"drops"=>[
        ...
        ["label"=>"Baumarkt","camping"=>7,"drops"=>[
        ...
        ["label"=>"Baustellencontainer","camping"=>7,"drops"=>[
        ...
        ["label"=>"Dönerbude Utsel-Brutzel","camping"=>7,"drops"=>[
            //TODO
        ]],
        ["label"=>"Dukes Villa","camping"=>7,"drops"=>[
        ...
        ["label"=>"Dunkler Hain","camping"=>7,"drops"=>[
        ...
        ["label"=>"Eingestürzte Mine","camping"=>7,"drops"=>[
        ...
        ["label"=>"Eingestürzter Steinbruch","camping"=>7,"drops"=>[
        ...
        ["label"=>"Familiengrab","camping"=>0,"drops"=>[
        ...
        ["label"=>"Fast Food Restaurant","camping"=>7,"drops"=>[
        ...
        ["label"=>"Flugzeugwrack","camping"=>9,"drops"=>[
        ...
        ["label"=>"Gartenhaus","camping"=>7,"drops"=>[
        ...
        ["label"=>"Geplünderte Mall","camping"=>5,"drops"=>[
        ...
        ["label"=>"Indianerfriedhof","camping"=>-5,"drops"=>[
        ...
        ["label"=>"Jahrmarktstand","camping"=>7,"drops"=>[
        ...
        ["label"=>"Kleines Haus","camping"=>7,"drops"=>[
        ...
        ["label"=>"Kleinwasserkraftwerk","camping"=>7,"drops"=>[
        ...
        ["label"=>"Kosmetiklabor","camping"=>9,"drops"=>[
        ...
        ["label"=>"Krankenwagen","camping"=>7,"drops"=>[
        ...
        ["label"=>"Lagerhalle","camping"=>7,"drops"=>[
        ...
        ["label"=>"Leeres Parkhaus","camping"=>7,"drops"=>[
        ...
        ["label"=>"Liegengebliebener Kampfpanzer","camping"=>9,"drops"=>[
        ...
        ["label"=>"Motel 'Dusk'","camping"=>7,"drops"=>[
            // ToDo
        ]],
        ["label"=>"Militärischer Wachposten","camping"=>9,"drops"=>[
        ...
        ["label"=>"Postfiliale","camping"=>7,"drops"=>[
        ...
        ["label"=>"Räuberhöhle","camping"=>7,"drops"=>[
        ...
        ["label"=>"Schützengraben","camping"=>9,"drops"=>[
        ...
        ["label"=>"Stadtbücherei","camping"=>7,"drops"=>[
        ...
        ["label"=>"Tante Emma Laden","camping"=>7,"drops"=>[
        ...
        ["label"=>"Truck 'Rathaus auf Rädern'","camping"=>7,"drops"=>[
            // ToDO
        ]],
        ["label"=>"Umgekippter Laster","camping"=>7,"drops"=>[
        ...
        ["label"=>"Verbrannte Grundschule","camping"=>9,"drops"=>[
        ...
        ["label"=>"Verfallenes Bürogebäude","camping"=>7,"drops"=>[
        ...
        ["label"=>"Verfallene Villa","camping"=>7,"drops"=>[
        ...
        ["label"=>"Verlassene Baustelle","camping"=>7,"drops"=>[
        ...
        ["label"=>"Verwilderter Park","camping"=>7,"drops"=>[
        ...
        ["label"=>"Waffengeschäft Guns'n'Zombies","camping"=>7,"drops"=>[
            // ToDo
        ]],
        ["label"=>"Warenlager","camping"=>7,"drops"=>[
            array('item' => 'chest_food_#00','count' => '43'),
            array('item' => 'chest_citizen_#00','count' => '34'),
            array('item' => 'chest_tools_#00','count' => '31'),
        ]],
        ["label"=>"Zelt eines Bürgers","camping"=>11,"drops"=>[
        ...
        ["label"=>"Zerstörte Apotheke","camping"=>7,"drops"=>[
        ...
        ["label"=>"ZomBIER Bar","camping"=>7,"drops"=>[
