...
class ActionFixtures extends Fixture implements DependentFixtureInterface
{
    public static $item_actions = [
        ...
        'actions' => [
            ...
            'bp_hospital_2' => [ 'label' => 'Lesen', 'meta' => [ 'must_be_inside' ], 'result' => [ 'consume_item', ['bp' => ['item_hmeat_#00', 'small_ikea_#00', 'small_tourello_#00', 'small_watchmen_#00', 'small_catapult3_#00'] ] ],                                                                            'message_key' => 'read_blueprint' ],
