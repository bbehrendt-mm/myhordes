...
class LogEntryTemplateFixtures extends Fixture
{
    public static $log_entry_template_data = [
        ...
        ['text'=>'%dogname%, der stinkende Köter von %citizen%, hat folgendes in die Bank gebracht: %item%', 'name'=>'bankGiveTamer', 'type'=>LogEntryTemplate::TypeBank, 'class'=>LogEntryTemplate::ClassNone, 'secondaryType'=>null, 'variableTypes'=>array(['type'=>"transString",'name'=>'dogname'],['type'=>"citizen",'name'=>'citizen'],['type'=>"item",'name'=>'item'])],
