...
class LogEntryTemplateFixtures extends Fixture
{
    public static $log_entry_template_data = [
        ...
        ['text'=>'%citizen% hat %items% in der Müllhalde zerstört (+%def% Verteidigung)', 'name'=>'dumpItems', 'type'=>LogEntryTemplate::TypeDump, 'class'=>LogEntryTemplate::ClassInfo, 'secondaryType'=>null, 'variableTypes'=>array(['type'=>"citizen",'name'=>'citizen'],['type'=>"list",'name'=>'items','listType'=>'item'],['type'=>'num','name'=>'def'])],
