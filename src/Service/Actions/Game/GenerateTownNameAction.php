...
            'sets' => [
                [   // Subjects
                    'f' => ['Toundra|s', 'Steppe|s', 'Pampa|s', 'Plaine|s', 'Prairie|s', 'Tranchée|s', 'Cavité|s', 'Fosse|s', 'Vallée|s', 'Immensité|s', 'Étendue|s', 'Multitude|s', 'Arène|s', 'Indolence|s', 'Ignorance|s', 'Colline|s', 'Installation|s', 'Promenade|s', 'Surface|s', 'Caverne|s', 'Contrée|s', 'Région|s', 'Dévastation|s', 'Désolation|s', 'Cité|s', 'Caserne|s', 'Rémanence|s', 'Falaise|s', 'Faille|s', 'Crique|s', 'Attraction|s', 'Annexe|s', 'Enclave|s', 'Communauté|s', 'Citadelle|s', 'Plantation|s', 'Gangrène|s', 'Frontière|s', 'Engeance|s', 'Jonction|s', 'Retraite|s', 'Terre|s', 'Croisée|s', 'Orbite|s', 'Structure|s', 'Côte|s', 'Butte|s', 'Coalition|s', 'Paranoïa|s', 'Inconnue|s', 'Cachette|s', 'Crête|s', 'Décharge|s', 'Dune|s', 'Éminence|s', 'Enceinte|s', 'Oasis', 'Planque|s', 'Forteresse|s', 'Gorge|s', 'Grange|s', 'Grotte|s', 'Halte|s', 'Hauteur|s', 'Lande|s', 'Pointe|s', 'Route|s', 'Tanière|s', 'Tombe|s', 'Zone|s'],
                    'm' => ['Abîme|s', 'Trou|s', 'Vide|s', 'Fossé|s', 'Canyon|s', 'Espace|s', 'Colisée|s', 'Espoir|s', 'Antre|s', 'Théâtre|s', 'Hypogée|s', 'Souterrain|s', 'Centre|s', 'Écho|s', 'Bidonville|s', 'Gouffre|s', 'Cloaque|s', 'Enfer|s', 'Mont|s', 'Village|s', 'Lieu-dit|<Lieux\-dits', 'Monolithe|s', 'Cimetière|s', 'Avant-poste|s', 'Camp|s', 'Refuge|s', 'Mystère|s', 'Hameau|x', 'Tombeau|x', 'Comté|s', 'Fort|s', 'Tertre|s', 'Coteau|x', 'Sommet|s', 'Bas-fond|s', 'Songe|s', 'Rempart|s', 'Tumulus', 'Abri|s', 'Asile|s', 'Avant-Poste|s', 'Bastion|s', 'Bourg|s', 'Carrefour|s', 'Champ|s', 'Cirque|s', 'Col|s', 'Cratère|s', 'Croisement|s', 'Dôme|s', 'Foyer|s', 'Havre|s', 'Jardin|s', 'Monticule|s', 'Mouroir|s', 'Mur|s', 'Nid|s', 'Plateau|x', 'Repère|s', 'Retranchement|s', 'Terrain|s', 'Val|-ux', 'Vestige|s'],
                    '*' => [ ],
                ],
                [   // Adjectives
                    'f' => ['noire|s', 'sanglante|s', 'morte|s', 'désolée|s', 'abandonnée|s', 'désertée|s', 'damnée|s', 'obscure|s', 'cachée|s', 'ternie|s', 'enterrée|s', 'perdue|s', 'disparue|s', 'ensevelie|s', 'blafarde|s', 'angoissante|s', 'ravagée|s', 'accablée|s', 'affligée|s', 'attristée|s', 'consternée|s', 'abattue|s', 'découragée|s', 'éplorée|s', 'mauvaise|s', 'brutale|s', 'dure|s', 'inhumaine|s', 'ignorante|s', 'arriérée|s', 'attardée|s', 'croulante|s', 'désuète|s', 'passée|s', 'périmée|s', 'grise|s', 'déprimante|s', 'perverse|s', 'infectée|s', 'gangrenée|s', 'corrompue|s', 'craquelée|s', 'contaminée|s', 'tétanisée|s', 'froide|s', 'chaude|s', 'inférieure|s', 'supérieure|s', 'déséquilibrée|s', 'obsédée|s', 'abritée|s', 'isolée|s', 'jaunie|s', 'maudite|s', 'moisie|s', 'désemparée|s', 'battue|s', 'anéantie|s', 'tendue|s', 'aberrante|s', 'abjecte|s', 'accidentée|s', 'affreuse|s', 'annihilée|s', 'bombardée|s', 'brisée|s', 'brûlée|s', 'cendrée|s', 'cruelle|s', 'déchiquetée|s', 'décomposée|s', 'défaite|s', 'délaissée|s', 'démente|s', 'dénaturée|s', 'dévastée|s', 'dévoyée|s', 'écrasée|s', 'écroulée|s', 'effondrée|s', 'engloutie|s', 'érodée|s', 'esseulée|s', 'éthérée|s', 'étoilée|s', 'éventrée|s', 'exilée|s', 'flétrie|s', 'frissonnante|s', 'hantée|s', 'indomptée|s', 'infecte|s', 'infernale|s', 'lacérée|s', 'mourante|s', 'nauséabonde|s', 'nécrosée|s', 'obstruée|s', 'odieuse|s', 'oppressante|s', 'oubliée|s', 'pestilentielle|s', 'primitive|s', 'souillée|s', 'spectrale|s', ' tordue|s', 'tourmentée|s', 'tremblante|s', 'viciée|s', 'vidée|s'],
                    'm' => ['noir|s', 'sanglant|s', 'mort|s', 'désolé|s', 'abandonné|s', 'déserté|s', 'damné|s', 'obscur|s', 'caché|s', 'terni|s', 'enterré|s', 'perdu|s', 'disparu|s', 'enseveli|s', 'blafard|s', 'angoissant|s', 'ravagé|s', 'accablé|s', 'affligé|s', 'attristé|s', 'consterné|s', 'abattu|s', 'découragé|s', 'éploré|s', 'mauvais', 'brutal|-ux', 'dur|s', 'inhumain|s', 'ignorant|s', 'arriéré|s', 'attardé|s', 'croulant|s', 'désuet|s', 'passé|s', 'périmé|s', 'gris', 'déprimant|s', 'pervers', 'infecté|s', 'gangrené|s', 'corrompu|s', 'craquelé|s', 'contaminé|s', 'tétanisé|s', 'froid|s', 'chaud|s', 'inférieur|s', 'supérieur|s', 'déséquilibré|s', 'obsédé|s', 'abrité|s', 'anéanti|s', 'tendu|s', 'aberrant|s', 'abject|s', 'accidenté|s', 'affreux', 'annihilé|s', 'bombardé|s', 'brisé|s', 'brûlé|s', 'cendré|s', 'cruel|s', 'déchiqueté|s', 'décomposé|s', 'défait|s', 'délaissé|s', 'dément|s', 'englouti|s', 'érodé|s', 'esseulé|s', 'éthéré|s', 'étoilé|s', 'éventré|s', 'exilé|s', 'flétri|s', 'frissonnant|s', 'hanté|s', 'indompté|s', 'infect|s', 'infernal|s', 'lacéré|s', 'mourant|s', 'nauséabond|s', 'nécrosé|s', 'obstrué|s', 'odieux', 'oppressant|s', 'oublié|s', 'pestilentiel|s', 'primitif|s', 'souillé|s', 'spectral|s', ' tordu|s', 'tourmenté|s', 'tremblant|s', 'vicié|s', 'vidé|s' ],
                    '*' => ['antique|s', 'verdâtre|s', 'sanguinaire|s', 'glauque|s', 'versicolore|s', 'putride|s', 'lugubre|s', 'crépusculaire|s', 'livide|s', 'sordide|s', 'funeste|s', 'macabre|s', 'épouvantable|s', 'funèbre|s', 'nocturne|s', 'triste|s', 'atrabilaire|s', 'maussade|s', 'mélancolique|s', 'morne|s', 'morose|s', 'sinistre|s', 'sombre|s', 'taciturne|s', 'grave|s', 'pénible|s', 'rude|s', 'médiocre|s', 'pitoyable|s', 'lamentable|s', 'atroce|s', 'barbare|s', 'féroce|s', 'impitoyable|s', 'implacable|s', 'inflexible|s', 'pénible|s', 'sauvage|s', 'inculte|s', 'rustre|s', 'vandale|s', 'fossile|s', 'passéiste|s', 'réactionnaire|s', 'rétrograde|s', 'obsolète|s', 'nostalgique|s', 'nordique|s', 'humide|s', 'archaïque|s', 'colérique|s', 'dirigiste|s', 'totalitaire|s', 'despotique|s', 'arriviste|s', 'anecdotique|s', 'pathétique|s', 'pourpre|s', 'rouge|s', 'étrange|s', 'austère|s', 'psychotique|s', 'abominable|s', 'déplorable|s', 'exsangue|s', 'fantomatique|s', 'farouche|s', 'fétide|s', 'horrible|s', 'immonde|s', 'indigne|s', 'insalubre|s', 'insondable|s', 'misérable|s', 'ocre|s', 'rance|s', 'saumâtre|s', 'solitaire|s', 'vétuste|s', 'aride|s', 'autoritaire|s', 'effroyable|s', 'infâme|s' ],
                ],
                [
                    // Suffixes
                    'f' => [ ],
                    'm' => [ ],
                    '*' => ['des Cordes', 'des Eléments tristes', 'des Gardiens effacés', 'des Fouineurs enterrés', 'des Éclaireurs disparus', 'des Noëlistes', 'des Hordes', 'de la Chimie naturelle', 'du Cyclope', 'de la Sphinge', 'du Rebond alpha', 'de l\'Anguille courbée', 'du Poisson Bulle', 'de McBess le folâtre', 'de l\'Or bleu', 'des Hydratones', 'des Lames de Fond', 'de Particules\' Bumdum', 'de Bumdum le versicolore', 'de Shoot\'em Up Bumdum', 'de Hiko Sharingan', 'de Hiko Twin', 'de Hiko le fruité', 'de Hk L\'insoumis', 'de Abyssal\' Hk ', 'de Hk le colorimétrique', 'de Yota le terrible', 'de Refactor Yota', 'de Warp le Magicien', 'de Warp l\'architecte', 'd\'Irvie le terrible', 'd\'HypIrvie', 'd\'Irvie aux Gommes', 'd\'Ani le coloré', 'd\'Ani enciélé', 'd\'Ani la Peintre', 'd\'Eole notre guide', 'd\'Eole l\'inspiratrice', 'de Shining Gygy', 'de Gyhyom le fluorescent', 'de Shaolin Kiroukou', 'de Kiroukou le poète', 'de Thinkslow', 'de Whitetigle le juste', 'de Whitetigle', 'de la Vérité de l\'Oméga', 'des États désunis', 'des viles Sangsues', 'des Bactéries', 'de la Paix verte', 'de Threepwood', 'des Norrissiens', 'de Shubi le coquin', 'des Capraphiles', 'des Antivilles', 'des Frutimetières', 'des Parcs ensevelis', 'des Maux oubliés', 'des Liners détruits', 'des Lapins morts et futés', 'des Tremblements de Terre', 'de la Marque du Loup', 'de Nô', 'des Ellipses', 'des Demies Vies', 'de LeChuck', 'du Gant de Combat', 'du Nunchaku à Molette', 'de la Nuit profonde', 'des Jumeaux mobiles', 'des Jumelles mobiles', 'des Conquis', 'des Tzongres noirs', 'des Piouz transis', 'd\'Hadès', 'de Junon pervertie', 'de Chéloné la lente', 'des Oubliés', 'des Aveugles brûlés', 'des Brûlés', 'de l\'Abîme', 'de la Faim', 'des Enfers', 'de Feu', 'du Vent fou', 'des Arts ubuesques', 'de l\'Âtre ancien', 'de l\'Indicible', 'des Grands Anciens', 'de l\'Usurpateur', 'du Plasticien taquin', 'des Chairs', 'des Peaux', 'des Ossements', 'du Pus', 'des Éclairs vacillants', 'des Membres de Pus', 'du Roi Corbeau', 'des Lépreux morts', 'de Molineux', 'des Pouilleux', 'de La Peste noire', 'des Abcès douloureux', 'de Putréfaction', 'des Pensées futiles', 'de Murakami', 'de l\'Oublié', 'des Perdus', 'de Celles qui prient', 'du morne Quotidien', 'des Sanglots sourds', 'des Larmes de Sang', 'de l\'Obscurité saine', 'de la Peur au Ventre', 'de l\'Angoisse ', 'des Miraculés bannis', 'des Nuits de l\'Horreur', 'de l\'Effroi', 'sans But', 'sans Lendemain', 'des Affamés', 'de la Soif', 'de la Mort lente', 'sans Fin', 'des Damnés', 'du Nord', 'du Sud', 'de l\'Est', 'de l\'Ouest', 'de l\'Orient', 'du Ponant', 'du Levant', ' du Septentrion', 'au Bord de l\'Abîme', 'des Nuits sans Fin', 'des Jours sans Fin', 'des premiers Jours', 'des Vents brûlants', 'des Vents sifflants', 'de la nouvelle Espérance', 'du Haut', 'du Tréfonds', 'de Twin', 'du vieux Parc à Fruits', 'de Goatswood', 'de Dunwich', 'de Dizan', 'd\'Arkham', 'de l\'Hiver', 'du Printemps', 'de l\'Été', 'de l\'Automne', 'des Brutes', 'des Sarcasmes', 'd\'Irma', 'des Lapinous', 'des Psychotiques', 'des Sadiques', 'des Vétérans', 'de l\'Armageddon', 'de la grande Contamination', 'de la Betapropine 99', ' des Insoumis', 'des Citoyens perdus', 'des Citoyens anonymes', 'des Anonymes', 'des Bannis', 'des Déshérités', 'sans Avenir', 'des Insurgés', 'du premier Jour', 'du Mistral perdant', 'de Yukito la cruelle', 'de Yukito la rédemptrice', 'des Effusions de Sang', 'de la Rédemption', 'des Gardiennes brisées', 'des Fouineuses ensevelies', 'des Éclaireuses égarées', 'des Norrissiennes', 'des Lapines mortes et futées', 'de la Marque de la Louve', 'des Conquises', 'de la Cyclope', 'du Sphinx', 'des Oubliées', 'des Aveugles brûlées', 'des Brûlées', 'des Grandes Anciennes', 'de l\'Usurpatrice', 'de la Plasticienne taquine', 'de la Reine Corbelle', 'des Lépreuses mortes', 'des Pouilleuses', 'de l\'Oubliée', 'des Perdues', 'de Ceux qui prient', 'des Miraculées bannies', 'des Affamées', 'des Damnées', 'des Insoumises', 'des Citoyennes perdues', 'des Citoyennes anonymes', 'des Déshéritées', 'des Bannies', 'de l\'Aube morte', 'de l\'Embrasement', 'de l\'Horreur', 'de l\'Ombre éternelle', 'de l\'Ours-Zombie', 'de l\'Outre-Monde', 'de l\'ultime Expédition', 'de la Braise mourante', 'de la Chair fétide', 'de la dernière Marche', 'de la dernière Nuit', 'de la Gangrène verte', 'de la Goulinette cendrée', 'de la Lune gibbeuse', 'de la Mort rampante', 'de la Porte noire', 'de la Porte fendue', 'de la Porte jaune', 'des Abysses muets', 'des Âmes égarées', 'des Anciens', 'des Anciennes', 'des Boyaux éventrés', 'des Cadavres froids', 'des Chaînes brisées', 'des Chamans éteints', ' des Chamanes éteintes', 'des Cranes fendus', 'des Exilés', 'des Exilées', 'des Flammes voraces', 'des Héros oubliés', 'des Héroïnes oubliées', 'des Mémoires effacées', 'des Nuées meurtrières', 'des Os brisés', 'des Plaies suintantes', 'des Promesses brisées', 'des Rêves engloutis', 'des Sapins calcinés', 'des Semeurs de Mort', 'des Semeuses de Mort', ' des Témoins', ' des Témoins angoissés', ' des Témoins pantoises', ' des Témoins muets', ' des Témoins muettes', 'des Tombes béantes', 'des Traîtres oubliés', 'des Traîtresses oubliées', 'des Ventres grondants', 'des Vents rugissants', 'du Baroud d\'Honneur', 'du Caveau final', 'du Chaos rampant', 'du Corbeau affamé', ' de la Corbelle affamée', 'du Crépuscule', 'du dernier Espoir', 'du Monolithe', 'du Mensonge éternel', 'du Mirage final', 'du Néant primordial', 'du Sang coagulé', 'du Solstice', 'du Tombeau scellé', 'du Valhalla', 'du Zénith noir', 'sans Rémission', 'sans Salut', 'des Apprivoiseurs empaillés', 'des Apprivoiseuses canées', 'des Techniciens grillés', 'des Techniciennes rouillées', 'des Ermites oubliées', 'des Ermites en paix', 'des Chamans envoûtés', 'des Chamanes ensorcelées', 'des Habitants ruinés', 'des Habitantes fauchées', 'du Sourire éternel', 'des Dunes de Sel', 'du Drapeau déchiré' ],
                ]
            ]
        ],
    ...
    private static array $town_mutator_snippets = [
        ...
        'christmas' => [
            ...
            'fr' => [
                [   // Subjects
                    'f' => [ 'Guirlande|s',  'Chaussette|s', 'Cheminée|e', 'Congère|s', 'Patinoire|s' ],
                    'm' => [ 'Renne|s', 'Elfe|s', 'Cadeau|x', 'Festival|-ux', 'Calendrier|s', 'Flocon', 'Train en bois',  'Pain d\'épice', 'Marché', 'Âtre|s' ],
                    '*' => [ ],
                ],
                [   // Adjectives
                    'f' => [ 'contemplative|s', 'enneigée|s', 'sainte|s', 'grelotante|s', 'fuligineuse|s', 'givrée|s', 'glacée|s', 'glaçante|s', 'décorée|s', 'étoilée|s' ],
                    'm' => [ 'contemplatif|s', 'enneigé|s', 'saint|s', 'grelotant|s', 'fuligineux', 'givré|s', 'glacé|s', 'glaçant|s', 'décoré|s', 'étoilé|s' ],
                    '*' => [  ],
                ],
                [
                    // Suffixes
                    'f' => [ ],
                    'm' => [ ],
                    '*' => ['du solstice blanc', 'dans la rafale de neige', 'dans la ruée vers le vin chaud', 'en neige', 'dans la neige', 'avec du vin chaud', 'dans la crèche ', 'dans l\'étable', 'sous le Sapin', 'de la fête foraine', 'de la longue nuit', 'de la longue veillée', 'des paquets vides', 'des bougies consummées'],
                ],
            ],
            'es' => [
                [   // Subjects
    ...
    public function __invoke(string $language, ?string &$schema = null, ?string $mutator = null): string
    {
