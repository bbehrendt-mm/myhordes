...
class Execution extends Base
{
    ...
    protected function getOwnKeys(TranslatorInterface $trans, WrapObjectsForOutputAction $wrapper): array {
        ...
        return [
            ...
            '{user__raw}'     => $this->citizen,
            '{citizen}'       => $wrapper($this->target_citizen),
            '{citizen__raw}'  => $this->target_citizen,
            '{target}'        => $this->originalTargetPrototype ? $wrapper($this->originalTargetPrototype) : $wrapper($this->target_citizen),
            '{target__raw}'   => $this->originalTargetPrototype ? null : $this->target_citizen,
