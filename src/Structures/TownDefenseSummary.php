...
class TownDefenseSummary
{
    ...
    public $dump_defense = 0;

    public function sum(): int {
        return $this->overall_scale * ($this->base_defense + $this->house_defense + $this->guardian_defense + $this->building_defense + $this->item_defense + $this->nightwatch_defense + $this->soul_defense + $this->dump_defense);
    }
}